  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        bg: 'bg-violet-50',
        hover: 'hover:bg-violet-100',
        filters: { pov_style: 'Second Person' },
      },
      {
        ...
        bg: 'bg-purple-50',
        hover: 'hover:bg-purple-100',
        filters: { pov_style: 'Third Person Limited' },
      },
      {
        ...
        bg: 'bg-rose-50',
        hover: 'hover:bg-rose-100',
        filters: { pov_style: 'Third Person Omniscient' },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        bg: 'bg-slate-50',
        hover: 'hover:bg-slate-100',
        filters: { pov_count: 'Multiple POV' },
      },
    ],
  },
  {

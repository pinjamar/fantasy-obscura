...
const CURATED_FAVORITES: Record<string, CuratedEntry[]> = {
  ...
  urban: [
    ...
    { title: 'Ninth House',                     slug: 'ninth-house' },
    { title: 'Crooked Kingdom',                 slug: 'crooked-kingdom' },
    { title: 'The Eye of the Bedlam Bride',     slug: 'the-eye-of-the-bedlam-bride' },
  ],
  historical: [
...
// All lists curated to 2023+ releases only. All slugs verified in DB.
const CURATED_NEW_RELEASES: Record<string, CuratedEntry[]> = {
  global: [
    ...
    { title: "Emily Wilde's Encyclopaedia of Faeries",   slug: 'emily-wildes-encyclopaedia-of-faeries' },
    { title: 'Yumi and the Nightmare Painter',           slug: 'yumi-and-the-nightmare-painter' },
    { title: 'Divine Rivals',                            slug: 'divine-rivals' },
  ...
  epic: [
    ...
    { title: 'The Sunlit Man',                           slug: 'the-sunlit-man' },
    { title: 'Yumi and the Nightmare Painter',           slug: 'yumi-and-the-nightmare-painter' },
    { title: 'Murtagh',                                  slug: 'murtagh' },
    { title: 'Sword Catcher',                            slug: 'sword-catcher' },
    { title: 'Of War and Ruin',                          slug: 'of-war-and-ruin' },
  ...
  romantasy: [
    ...
    { title: 'Yumi and the Nightmare Painter',           slug: 'yumi-and-the-nightmare-painter' },
    { title: 'Divine Rivals',                            slug: 'divine-rivals' },
    { title: 'Last Violent Call',                        slug: 'last-violent-call' },
  ...
  grimdark: [
    ...
    { title: 'The Tyranny of Faith',                     slug: 'the-tyranny-of-faith' },
    { title: 'Of War and Ruin',                          slug: 'of-war-and-ruin' },
    { title: 'Iron Flame',                               slug: 'iron-flame' },
    { title: 'The Warm Hands of Ghosts',                 slug: 'the-warm-hands-of-ghosts' },
    { title: 'Tress of the Emerald Sea',                 slug: 'tress-of-the-emerald-sea' },
  ...
  dark: [
    ...
    { title: 'Tress of the Emerald Sea',                 slug: 'tress-of-the-emerald-sea' },
    { title: 'Yumi and the Nightmare Painter',           slug: 'yumi-and-the-nightmare-painter' },
    { title: 'The Book That Broke the World',            slug: 'the-book-that-broke-the-world' },
  ],
  urban: [
    { title: 'The Tainted Cup',                          slug: 'the-tainted-cup' },
    { title: 'Wind and Truth',                           slug: 'wind-and-truth' },
  ...
  academy: [
    ...
    { title: 'Yumi and the Nightmare Painter',           slug: 'yumi-and-the-nightmare-painter' },
    { title: 'The Tainted Cup',                          slug: 'the-tainted-cup' },
    { title: 'The Will of the Many',                     slug: 'the-will-of-the-many' },
    { title: 'The Sunlit Man',                           slug: 'the-sunlit-man' },
    { title: 'Tress of the Emerald Sea',                 slug: 'tress-of-the-emerald-sea' },
    { title: 'Wind and Truth',                           slug: 'wind-and-truth' },
    { title: 'Murtagh',                                  slug: 'murtagh' },
...
const booksLike: Array<{ slug: string; title: string; dbTitle?: string }> = [
  { slug: 'acotar',                        title: 'A Court of Thorns and Roses'  },
  { slug: 'mistborn-the-final-empire',     title: 'Mistborn',  dbTitle: 'The Final Empire' },
  { slug: 'fourth-wing',                   title: 'Fourth Wing'                  },
  { slug: 'the-name-of-the-wind',          title: 'The Name of the Wind'         },
  { slug: 'six-of-crows',                  title: 'Six of Crows'                 },
  { slug: 'the-way-of-kings',              title: 'The Way of Kings'             },
  { slug: 'red-rising',                    title: 'Red Rising'                   },
  { slug: 'the-poppy-war',                 title: 'The Poppy War'                },
  { slug: 'legends-and-lattes',            title: 'Legends & Lattes'             },
  { slug: 'the-priory-of-the-orange-tree', title: 'The Priory of the Orange Tree'},
  { slug: 'piranesi',                      title: 'Piranesi'                     },
  { slug: 'the-goblin-emperor',            title: 'The Goblin Emperor'           },
];
      ...
      <div className="mt-6 flex flex-col gap-6">
        ...
        {newReleases.length > 0 && (
          <div className="rounded-lg border bg-linear-to-br from-emerald-50 to-teal-50 p-5">
            <div className="flex items-center gap-2 mb-3">
              <span className="text-lg">✨</span>
              <h3 className="font-semibold text-emerald-900">{selectedCat ? categoryName : 'Fantasy'} Recent Releases</h3>

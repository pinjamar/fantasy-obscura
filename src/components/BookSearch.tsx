                  ...
                  <li key={book.id}>
                    {href ? (
                      ...
                      >
                        {book.cover_url ? (
                          <img
                            src={normalizeCoverUrl(book.cover_url)!}
                            alt=""
                            className="w-8 h-12 object-cover rounded shrink-0"
                          />
                        ) : (
                          <div className="w-8 h-12 rounded bg-purple-100 flex items-center justify-center text-base shrink-0">
                            📖
                          </div>
                        )}
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            {book.darkness_level != null && (
                              <span className="text-[10px] text-zinc-400">
                                {'🕯️'.repeat(book.darkness_level)}
                              </span>
                            )}
                            {book.subgenres?.[0] && (
                        ...
                        {book.avg_rating && (
                          <span className="ml-auto text-xs text-zinc-400 shrink-0 inline-flex items-center gap-1">

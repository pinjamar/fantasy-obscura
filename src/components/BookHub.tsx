...
import type { BookInput, BookSearchResult } from '../lib/books/types';
...
const BookHub: React.FC = () => {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-2xl border p-6">
        <h2 className="text-xl font-semibold">Manual book entry</h2>
        <p className="mt-2 text-sm text-zinc-600">
          Add a custom book that isn’t in the APIs.
        </p>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(event) =>
                setForm({ ...form, subgenres: parseTags(event.target.value) })
              }
            />
          </div>
          <div>
            <label className="text-sm font-medium">Tropes</label>
            <input
              className="mt-1 w-full rounded-lg border px-3 py-2 text-sm"
          ...
          <div>
            <label className="text-sm font-medium">Diversity rep</label>
            <input
              className="mt-1 w-full rounded-lg border px-3 py-2 text-sm"

...
const trope: PublicTrope = {
  ...
  intro: "A curse in fantasy is different from a problem. A problem can be solved; a curse reshapes everything you're allowed to be. The character can't simply work harder or be cleverer, because the constraint is built into the rules of the world, and the story is about learning to live inside it.\n\n*Elantris* puts its protagonist among the living dead who can't die but can't function, trapped in permanent partial sensation, and asks what kind of society two people can build from inside that horror.\n\n*The Invisible Life of Addie LaRue* goes further: Addie's curse isn't pain but erasure, and the cost isn't physical but relational. One book asks what you can build inside a broken body. The other asks what you can build when no one remembers you built anything at all.",
  ...
  booksLikeGuides: ["a-court-of-thorns-and-roses", "elantris", "circe", "spinning-silver", "gild", "the-cruel-prince", "thornhedge"],
  editorialFaqs: [

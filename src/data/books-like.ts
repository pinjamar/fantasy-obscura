...
import { piranesi } from './books-like/piranesi';
import { thePoppyWar } from './books-like/the-poppy-war';
import { thePrioryOfTheOrangeTree } from './books-like/the-priory-of-the-orange-tree';
import { redRising } from './books-like/red-rising';
import { sixOfCrows } from './books-like/six-of-crows';
import { uprooted } from './books-like/uprooted';
import { theWayOfKings } from './books-like/the-way-of-kings';
import { dragonlance } from './books-like/dragonlance';
import { dragonflight } from './books-like/dragonflight';
import { legendOfDrizzt } from './books-like/legend-of-drizzt';
import { theWheelOfTime } from './books-like/the-wheel-of-time';
import { theWillOfTheMany } from './books-like/the-will-of-the-many';
import { circe } from './books-like/circe';
import { assassinsApprentice } from './books-like/assassins-apprentice';
import { goodOmens } from './books-like/good-omens';
import { aPsalmForTheWildBuilt } from './books-like/a-psalm-for-the-wild-built';
import { theVerySecretSocietyOfIrregularWitches } from './books-like/the-very-secret-society-of-irregular-witches';
import { thornhedge } from './books-like/thornhedge';
...
import { theBladeitself } from './books-like/the-blade-itself';
import { aLittleHatred } from './books-like/a-little-hatred';
import { theLiesOfLockeLamora } from './books-like/the-lies-of-locke-lamora';
import { throneOfGlass } from './books-like/throne-of-glass';
import { theHouseInTheCeruleanSea } from './books-like/the-house-in-the-cerulean-sea';
import { elantris } from './books-like/elantris';
import { kingdomOfTheWicked } from './books-like/kingdom-of-the-wicked';
import { princeOfThorns } from './books-like/prince-of-thorns';
import { warbreaker } from './books-like/warbreaker';
import { spinningSilver } from './books-like/spinning-silver';
import { theNightCircus } from './books-like/the-night-circus';
import { theCityOfBrass } from './books-like/the-city-of-brass';
import { crescentCity } from './books-like/crescent-city';
import { bestServedCold } from './books-like/best-served-cold';
import { anEmberInTheAshes } from './books-like/an-ember-in-the-ashes';
import { theSwordOfKaigen } from './books-like/the-sword-of-kaigen';
import { theFifthSeason } from './books-like/the-fifth-season';
import { theHeroes } from './books-like/the-heroes';
import { theWitcher } from './books-like/the-witcher';
import { gideonTheNinth } from './books-like/gideon-the-ninth';
import { houseOfFlameAndShadow } from './books-like/house-of-flame-and-shadow';
import { theDarkTower } from './books-like/the-dark-tower';
import { discworld } from './books-like/discworld';
import { malazan } from './books-like/malazan';
import { aDeadlyEducation } from './books-like/a-deadly-education';
import { aMemoryCalledEmpire } from './books-like/a-memory-called-empire';
import { aTouchOfDarkness } from './books-like/a-touch-of-darkness';
import { theCruelPrince } from './books-like/the-cruel-prince';
import { childrenOfBloodAndBone } from './books-like/children-of-blood-and-bone';
import { daughterOfTheMoonGoddess } from './books-like/daughter-of-the-moon-goddess';
import { emilyWilde } from './books-like/emily-wilde';
import { aWizardOfEarthsea } from './books-like/a-wizard-of-earthsea';
import { stormFront } from './books-like/storm-front';
import { redCountry } from './books-like/red-country';
import { theBridgeKingdom } from './books-like/the-bridge-kingdom';
import { gild } from './books-like/gild';
...
export const BOOKS_LIKE: BooksLikeEntry[] = [
  ...
  theVerySecretSocietyOfIrregularWitches,
  thornhedge,
  americanGods,
  eragon,
  dungeonCrawlerCarl,
  ...
  },
  {
    ...
    aspects: [
      {
        heading:
          'If you loved the faction system — a society that sorts people into enforced categories, and a heroine who cannot be sorted...',
        recs: [
          {
            title: 'The Hunger Games',
            author: 'Suzanne Collins',
          ...
          {
            title: 'Legend',
            slug: 'legend-marie-lu',
            author: 'Marie Lu',
            cover_url:
              'https://books.google.com/books/content?id=dHY4AAAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
            darkness_level: 3,
            heat_level: null,
            standalone: false,
            series: 'Legend',
            ...
            bookshop_url:
              'https://bookshop.org/search?keywords=Legend+Marie+Lu&affiliate=122720',
          },
        ],
      },
      {
        heading:
          'If you loved the Dauntless initiation — the brutal training, the competition, the permanent threat of being cut...',
        recs: [
          {
            title: 'Red Rising',
            author: 'Pierce Brown',
      ...
      {
        heading:
          'If you loved Four — the controlled, guarded instructor with a hidden history who becomes the one person the heroine trusts...',
        recs: [
          {
            title: 'Shatter Me',
            author: 'Tahereh Mafi',
            ...
            bookshop_url:
              'https://bookshop.org/search?keywords=Shatter+Me+Mafi&affiliate=122720',
          },
          {
            title: 'Shadow and Bone',
            author: 'Leigh Bardugo',
    ...
    recommendations: [
      ...
      },
      {
        ...
        darkness_level: 3,
        heat_level: null,
        tags: ['Dual POV', 'Dystopian', 'Enemies to Lovers', 'YA'],
        why: "The most structurally similar book most Divergent readers miss: a future society with a golden girl and a fugitive boy, told in dual POV as they converge on the same government conspiracy. Lu's world-building is sharper than Roth's and the dual perspective gives the romance a propulsive tension. If you want the faction-system energy with tighter plotting, start here.",
        standalone: false,
        audiobook: true,
        amazon_url:
          'https://www.amazon.com/s?k=Legend+Marie+Lu&tag=librariancura-20',
      ...
      },
      {
        ...
        darkness_level: 4,
        heat_level: 'Closed Door',
        tags: ['Military Academy', 'Brutal Trials', 'Dual POV', 'YA Fantasy'],
        why: "A Roman empire, a military academy where initiates fight for their lives, and a slow-burn dual POV romance between an infiltrator and a soldier. Tahir's Trials are Divergent's initiation pushed harder — brutal tests run by people playing a different game than the participants understand. One of the best YA fantasy series of the 2010s, and chronically underread by Divergent fans.",
        standalone: false,
        audiobook: true,
        amazon_url:
          'https://www.amazon.com/s?k=An+Ember+in+the+Ashes+Sabaa+Tahir&tag=librariancura-20',
  ...
  },
  {
    ...
    source: {
      title: 'The Bear and the Nightingale',
      author: 'Katherine Arden',
      db_slug: 'the-bear-and-the-nightingale',
      ...
      tropes: [
        'Slavic Folklore',
        'Wild Unconventional Heroine',
        'Old Gods vs Christianity',
        'Winter Atmosphere',
        'Household Spirits',
        'Fae-Adjacent Love Interest',
        'Coming of Age',
      ],
    ...
    aspects: [
      {
        heading: 'If you loved the Slavic folklore and winter atmosphere...',
        recs: [
          {
  ...
  },
  {
    ...
    source: {
      title: 'Jonathan Strange & Mr Norrell',
      author: 'Susanna Clarke',
      db_slug: 'jonathan-strange-mr-norrell',
    ...
    recommendations: [
      ...
      },
      {
        ...
        darkness_level: 4,
        tags: ['Old Gods', 'Inhuman Entities', 'Mythology', 'Dark'],
    ...
    recommendations: [
      {
        ...
        darkness_level: 1,
        heat_level: 'Closed Door',
        tags: ['Hopeful', 'Found Family', 'Cosy Fantasy', 'Gentle Philosophy'],
      ...
      },
      {
        ...
        cover_url: 'https://covers.openlibrary.org/b/isbn/9781526622426-L.jpg',
        darkness_level: 2,
        tags: ['Impossible World', 'Mystery', 'Identity', 'Literary'],
  ...
  },
  {
    ...
    recommendations: [
      ...
      },
      {
        ...
        darkness_level: 3,
        heat_level: 'Closed Door',
        tags: ['F/F Romance', 'Epic Fantasy', 'Political Stakes', 'Standalone'],
  ...
  },
  {
    ...
    aspects: [
      ...
      {
        heading: 'If you loved the hidden powers and the forbidden romance...',
        recs: [
          {
            title: 'From Blood and Ash',
            author: 'Jennifer L. Armentrout',
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Zachary Ezra Rawlins finds a book in his university library that contains a story about himself as a child — a door he didn't open — and follows the thread of it down into a vast underground world of honey and secrets and stories that have been accumulating for centuries. Morgenstern's second novel is less a plot-driven story than an immersive experience: a world built from the logic of libraries and fairy tales and the kind of story that feels like it has always existed, and she is more interested in texture and feeling than in conventional narrative momentum. The Starless Sea is a book for readers who have spent their lives in love with books, who have ever felt that the world inside a story is more real than the world outside it. It rewards patience and surrender — the reader who tries to track its plot mechanics will miss what it is doing — and leaves behind something that feels less like a memory of a novel than a memory of a place.",
    },
    aspects: [
      {
        heading:
          'If you loved the atmosphere — the underground library world, the honey and the harbours, the sense of a place that has existed forever just below the surface of the real...',
        recs: [
          {
            title: 'The Night Circus',
            author: 'Erin Morgenstern',
      ...
      {
        heading:
          'If you loved the meta-narrative — stories nested inside stories, the book that knows it is a book, the sense that fiction and reality are the same substance...',
        recs: [
          {
            title: 'Piranesi',
            author: 'Susanna Clarke',
      ...
      {
        heading:
          'If you loved the love story — Zachary and Dorian, the romance that unfolds in a world outside time, the feeling of two people finding each other in the only place they could have...',
        recs: [
          {
            title: 'The Invisible Life of Addie LaRue',
            author: 'V.E. Schwab',
          ...
          },
          {
            ...
            cover_url: 'https://covers.openlibrary.org/b/id/7267388-L.jpg',
            darkness_level: 2,
            heat_level: 'Closed Door',
            standalone: false,
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Patroclus is an awkward, unheroic boy sent to the court of King Peleus, where he meets Achilles — golden, gifted, already legendary — and the two become inseparable over years of training, exile, and eventual war. Miller retells the Iliad from Patroclus's perspective, and what she achieves is something genuinely rare: a love story whose emotional power is proportional to the reader's knowledge that it ends in grief. The prose is luminous without being showy, Miller's Homer is deeply researched and deeply felt, and the romantic arc — the slow progression from boyhood friendship to something neither of them has words for — is built with enough patience that the devastation of the final third lands with full force. It made a generation of readers cry on public transport and rediscover mythology, and nothing that followed has quite replicated what it does.",
    },
    aspects: [
      {
        heading:
          'If you loved the mythology retelling — the Greek world made visceral and intimate, the gods walking among mortals with terrifying casualness...',
        recs: [
          {
            title: 'Circe',
            author: 'Madeline Miller',
      ...
      {
        heading:
          'If you loved the doomed romance — the knowledge that it ends badly woven into every tender moment, love that is inseparable from grief...',
        recs: [
          {
            title: 'Babel',
            author: 'R.F. Kuang',
      ...
      {
        heading:
          'If you loved the prose — the way Miller writes antiquity, the clarity and weight of every sentence, the feeling of reading something that will stay with you...',
        recs: [
          {
            title: 'A Thousand Ships',
            author: 'Natalie Haynes',
            cover_url: 'https://covers.openlibrary.org/b/id/10294341-L.jpg',
            darkness_level: 4,
            heat_level: null,
            standalone: true,
            audiobook: true,
  ...
  },
  {
    ...
    aspects: [
      {
        heading:
          'If you loved the dark academic atmosphere — Oxford as a place of genuine beauty and genuine violence, the specific pleasure and specific cost of belonging to an elite institution...',
        recs: [
          {
            title: 'The Atlas Six',
            author: 'Olivie Blake',
      ...
      {
        heading:
          'If you loved the colonial critique — the way Kuang uses fantasy mechanics to make the logic of empire visceral, the specific anger of loving something that is eating you...',
        recs: [
          {
            title: 'The Poppy War',
            author: 'R.F. Kuang',
  ...
  },
  {
    ...
    aspects: [
      ...
      {
        heading:
          'If you loved the unreliable reality — the dreamlike logic where nothing is what it seems and the truth keeps shifting under your feet...',
        recs: [
          {
            title: 'Piranesi',
            author: 'Susanna Clarke',
      ...
      {
        heading:
          'If you loved the sister relationship — Scarlett and Donatella, the pull between protecting someone and letting them make their own terrible choices...',
        recs: [
          {
            title: 'Spinning Silver',
            author: 'Naomi Novik',
  ...
  {
    slug: 'assistant-to-the-villain',
    source: {
      title: 'Assistant to the Villain',
      author: 'Hannah Nicole Maehrer',
      cover_url: 'https://covers.openlibrary.org/b/isbn/9781728270012-L.jpg',
      darkness_level: 2,
      heat_level: 'Closed Door',
        ...
        recs: [
          {
            ...
            heat_level: 'Closed Door',
            standalone: false,
            series: 'The Hurricane Wars Trilogy',
            series_number: 1,
            series_label: 'Trilogy (complete)',
            audiobook: true,
  ...
  },
  {
    ...
    source: {
      title: 'Blood Song',
      author: 'Anthony Ryan',
      cover_url: 'https://covers.openlibrary.org/b/isbn/9780425268582-L.jpg',
      darkness_level: 4,
      heat_level: null,
    ...
    aspects: [
      {
        heading:
          'If you loved the frame narrative — Vaelin telling his own legend after the fact, the gap between the story and the teller, knowing something terrible is coming...',
        recs: [
          {
            title: 'The Name of the Wind',
            author: 'Patrick Rothfuss',
      ...
      {
        heading:
          'If you loved the military brotherhood — the Sixth Order as a found family forged by shared hardship, the loyalty between soldiers who trained together...',
        recs: [
          {
      ...
      {
        heading:
          'If you loved the training arc — the brutal initiation, learning from masters, earning mastery through years of hardship rather than a sudden power-up...',
        recs: [
          {
            title: 'Red Sister',
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Lyra Belacqua lives in an Oxford where every person has a daemon — an animal companion that is the external, visible form of their soul — and when children start disappearing and she stumbles into a conspiracy that reaches from the Church to the Arctic and beyond, she sets off to find them. What makes His Dark Materials one of the great fantasy trilogies is that Pullman is doing at least three things at once: writing a genuinely propulsive adventure with a brilliantly realised protagonist, building a multiverse of parallel worlds with different physics and different metaphysics, and mounting a sustained philosophical argument about the nature of consciousness, free will, and what organised religion does to human experience. Lyra is one of the finest child protagonists in the genre — curious, reckless, constitutionally unable to tell a straight truth, and morally serious in ways she doesn't yet have the language to articulate. The series gets progressively more demanding as it goes; The Amber Spyglass is dense with ideas and divides readers who came for the adventure. But Northern Lights / The Golden Compass is close to perfect, and the world of daemons and Dust is unlike anything else in fantasy.",
    },
    aspects: [
      {
        heading:
          'If you loved the philosophical underpinning — the way Pullman builds a fantasy around questions about consciousness, free will, and what Dust actually is...',
        recs: [
          {
            title: 'Piranesi',
            author: 'Susanna Clarke',
      ...
      {
        heading:
          'If you loved the coming-of-age arc — Lyra discovering the world is larger and more dangerous than she knew, and that the adults in charge cannot always be trusted...',
        recs: [
          {
      ...
      {
        heading:
          'If you loved the world-building — the alternate Oxford, the daemons, the alethiometer, the way every object and institution carries a different history...',
        recs: [
          {
            title: 'The Bear and the Nightingale',
            author: 'Katherine Arden',
  ...
  // ── Sorcery of Thorns ───────────────────────────────────────────────────────
  {
    ...
    source: {
      ...
      angle: 'Gothic Library Fantasy',
      answer_line:
        'If you loved Sorcery of Thorns for the sentient magical grimoires, the gothic library atmosphere, and the slow-burn enemies-to-lovers between Elisabeth and Nathaniel, start with Uprooted, Strange the Dreamer, and The Invisible Library.',
      why_people_love:
        "Sorcery of Thorns works because it understands that books are not just containers for stories — in Rogerson's world, they are the stories, alive and dangerous and capable of destroying you if you love them wrong. Elisabeth is one of the best protagonists in YA fantasy: competent, direct, genuinely brave in the physical sense rather than the chosen-one sense, and completely unprepared for a sorcerer who is not what she was told. Nathaniel Thorn and his demon Silas are the real draws: one a sharp-tongued aristocrat hiding grief behind performance, the other an ancient creature who chose loyalty as a form of love. The gothic atmosphere is consistent and immersive — this is a book that smells like old paper and candlelight. Fair warning: it's YA, and the romance stays closed-door. If you're coming for heat, this isn't it. You're here for the tension and the world.",
    },
    aspects: [
      {
        heading:
    ...
    related: [
      { title: 'Books Like Uprooted', slug: 'uprooted' },
      { title: 'Books Like The Night Circus', slug: 'the-night-circus' },
      { title: 'Books Like Strange the Dreamer', slug: 'strange-the-dreamer' },
    ],
  },

  // ── Witch of Wild Things ─────────────────────────────────────────────────────
  {
    slug: 'witch-of-wild-things',
    source: {
      ...
      angle: 'Contemporary Magical Romance',
      answer_line:
        "If you loved Witch of Wild Things for the emotion-tied plant magic, the enemies-to-lovers workplace tension, and the cozy contemporary magic atmosphere, start with A Witch's Guide to Fake Dating a Demon, The Very Secret Society of Irregular Witches, and Cemetery Boys.",
      why_people_love:
        "Witch of Wild Things works because Vasquez Gilliland understood that the best magic systems aren't really about power — they're about feeling. Sage's plants grow out of control when she's overwhelmed; Teal kills them without trying. Two people whose magic literally repels each other, forced into close quarters by a work project, circling something neither will name. The contemporary setting does real work here: magic woven into a mundane life of deadlines and coffee and trying to be professional is more romantic than magic in a castle. The banter is sharp, the slow burn earns its ending, and Sage is a genuinely warm protagonist to spend time with. Fair warning: this is primarily a romance novel with magical realism seasoning. If you're coming for fantasy worldbuilding, recalibrate — there isn't much of it. You're here for the feelings.",
    },
    aspects: [
      {
        heading:
  ...
  },
  {
    ...
    aspects: [
      {
        heading:
          'If you loved Gideon — a love interest who is, by definition, the enemy of what you are, and the romance is built entirely on that impossibility...',
        recs: [
          {
            title: 'Serpent & Dove',
            slug: 'serpent-dove',
      ...
      {
        heading:
          'If you loved the Crimson Moth — maintaining two irreconcilable identities, where the wrong person seeing too clearly means everything falls apart...',
        recs: [
          {
            title: 'The Cruel Prince',
            author: 'Holly Black',
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Perry brings her contemporary romance instincts into a high fantasy setting and the result is a book that works for readers who wouldn't usually pick up epic fantasy: the world-building is present but the emotional engine is the relationship. The setup — a stranger arrives and demands the overlooked princess as his price — is the kind of fairy-tale premise that carries its own logic, and Perry uses it to do what she does in her contemporary work: build a heroine who has been told she doesn't matter, put her in proximity with someone who disagrees, and let the slow reveal of both of them happen in parallel. The divine mythology (gods who gave humanity beautiful creatures, gods' jealous children who made dangerous ones) gives the world stakes beyond the personal without demanding that the reader track elaborate lore. Readers who come from Perry's contemporary catalogue tend to find the tonal register familiar — the warmth is the same, only the setting has changed.",
    },
    aspects: [
      {
        heading:
          'If you loved being given as his price — the heroine traded to a stranger as the cost of something the kingdom desperately needs...',
        recs: [
          {
            title: 'Uprooted',
            author: 'Naomi Novik',
      ...
      {
        heading:
          'If you loved the divine mythology — a world where the gods shaped everything and their jealous children unmade it...',
        recs: [
          {
            title: 'A Court of Thorns and Roses',
            author: 'Sarah J. Maas',
  ...
  {
    slug: 'the-awakening-zodiac-academy',
    source: {
      title: 'The Awakening',
  ...
  },
  {
    ...
    aspects: [
      {
        heading:
          'If you loved Rocky — the alien friendship that made this book, built from first contact through problem-solving into something the English language barely has words for...',
        recs: [
          {
      ...
      {
        heading:
          'If you loved waking up with Grace — no memory, an impossible mission, the world revealing itself piece by piece as he figures out what he volunteered for...',
        recs: [
          {
            title: 'Dark Matter',
            author: 'Blake Crouch',
  ...
  },
  {
    ...
    aspects: [
      {
        heading:
          'If you loved the framed narrative — Gabriel imprisoned, telling the true story of his life to a vampire scribe, with the whole weight of a finished legend in his voice...',
        recs: [
          {
            title: 'The Name of the Wind',
            author: 'Patrick Rothfuss',
          ...
          },
          {
            ...
            series_number: 1,
            series_label: 'Trilogy (part of a 9-book world)',
            audiobook: true,
            note: "The older Fitz narrating his own past shares Gabriel's particular melancholy: the retrospective voice of someone who lived through extraordinary things and survived them badly, looking back with the knowledge of which of those people are dead. Hobb's emotional depth is unmatched in the genre — FitzChivalry's found-family with the royal court, his bond with the Fool, and his relationship with his own monstrous training are handled with the same psychological precision Kristoff brings to Gabriel's silversaints. The darkness is structural rather than gratuitous, and the tragedy is earned. Caveat: slower and more introspective than Kristoff — if you want kinetic set-pieces, this isn't it.",
            tags: [
            ...
            amazon_url:
              'https://www.amazon.com/s?k=Assassins+Apprentice+Robin+Hobb&tag=librariancura-20',
            bookshop_url:
              'https://bookshop.org/search?keywords=Assassins+Apprentice+Robin+Hobb&affiliate=122720',
          },
        ],
      },
      {
        heading:
          'If you loved the dying sun world — where the vampires already won centuries ago and the book is set in the long aftermath of that defeat...',
        recs: [
          {
            title: 'The Poppy War',
            author: 'R.F. Kuang',
            ...
            series_label: 'Trilogy',
            audiobook: true,
            note: "A world where the enemy is a civilisational force and the protagonist's resistance becomes increasingly costly, dark, and morally compromised as the scale of destruction becomes clear. Kuang builds the same logic as Kristoff's vampire empire: the monsters are winning because they have structural advantages, not just because they're scary. Rin's trajectory from underdog soldier to something that may be as dangerous as what she's fighting mirrors Gabriel's dhampir identity. The prose is blunt rather than maximalist, but the darkness is equally unsparing — this is the other grimdark novel that earns its brutality. Caveat: based on real historical atrocity (the Sino-Japanese War), which is harder-edged than fictional darkness.",
            tags: [
              'Civilisational War',
              'Dark Fantasy',
              'Protagonist Becoming the Monster',
              'Morally Compromised Hero',
              'Brutal World',
            ],
            amazon_url:
              'https://www.amazon.com/s?k=The+Poppy+War+RF+Kuang&tag=librariancura-20',
          ...
          },
          {
            ...
            series_label: 'Trilogy',
            audiobook: true,
            note: "A world in terminal civilisational decline — not a dramatic collapse but a place that has always known it will end, built its entire culture around that knowledge, and is now reaching the final event. Jemisin's structural innovation (second-person narration, non-linear timeline reveals) does the same work as Kristoff's framing device: the narration itself carries information about what happened that the surface story hasn't revealed yet. The protagonist has power she can't fully control that makes her dangerous to everything she loves. Caveat: quieter and more formally experimental than Empire of the Vampire — this is a prose novel, not a kinetic one.",
            tags: [
              'Dying World',
              'Structural Narrative Innovation',
              'Morally Complex Protagonist',
      ...
      {
        heading:
          'If you loved Gabriel as the dhampir — kin to the vampires he hunts, carrying a darkness he has to control, belonging to neither world fully...',
        recs: [
          {
            title: 'The Last Wish',
            ...
            standalone: true,
            audiobook: true,
            note: "Geralt of Rivia is the foundational template for Gabriel's archetype: a professional monster hunter who is himself a created monster, operating in the gap between human civilization and the creatures that threaten it, valued for what he does and mistrusted for what he is. Sapkowski builds the moral complexity around Geralt with the same seriousness Kristoff brings to Gabriel — the half-monster identity is structural, not cosmetic, and it shapes every relationship in the story. The prose (in translation) is dry and ironic where Kristoff is maximalist. Caveat: the short story collection format of The Last Wish means it reads as episodes rather than a continuous narrative.",
            tags: [
              'Monster Hunter',
            ...
            amazon_url:
              'https://www.amazon.com/s?k=The+Last+Wish+Witcher+Sapkowski&tag=librariancura-20',
            bookshop_url:
              'https://bookshop.org/search?keywords=The+Last+Wish+Witcher+Sapkowski&affiliate=122720',
          },
          {
            title: 'Blood Song',
            author: 'Anthony Ryan',
            ...
            series_label: 'Trilogy',
            audiobook: true,
            note: "Vaelin Al Sorna is trained from childhood to be something the Church needs but society can't fully accept — a weapon with a moral code, belonging to an order that shapes him into a creature partly outside normal human experience. The warrior-brotherhood structure mirrors the silversaints exactly: the found family of the Order, the training that costs something real, the loyalty that persists even as the institution that created it fails. Ryan's prose is functional rather than maximalist, but the emotional weight of the brotherhood and the mounting tragic logic of Vaelin's story track closely. Caveat: the second and third books of the trilogy are widely considered a significant step down from the first.",
            tags: [
              'Warrior Brotherhood',
  ...
  },
  {
    ...
    aspects: [
      ...
      {
        heading:
          'If you loved Lowe — an Alpha who is quietly, consistently dangerous, deeply loyal to his pack, and whose feelings for Misery accumulate through action long before he admits to them...',
        recs: [
          {
            title: 'A Touch of Darkness',
            author: 'Scarlett St. Clair',
      ...
      },
      {
        ...
        recs: [
          ...
          },
          {
            ...
            amazon_url:
              'https://www.amazon.com/s?k=When+the+Moon+Hatched+Sarah+Parker&tag=librariancura-20',
            bookshop_url:
              'https://bookshop.org/search?keywords=When+the+Moon+Hatched+Parker&affiliate=122720',
          },
        ],
      },
    ],
    ...
    related: [
      ...
      { title: 'Books Like A Touch of Darkness', slug: 'a-touch-of-darkness' },
    ],
  },
  {
  ...
  },
  {
    ...
    source: {
      ...
      angle: 'The Godfather as Asian-Inspired Fantasy',
      answer_line:
    ...
    aspects: [
      {
        heading:
          'If you loved the Kaul family — siblings bound by duty, loyalty that costs more than it gives...',
        recs: [
          {
      ...
      {
        heading:
          'If you loved the jade — magic inseparable from cultural identity, with a cost that is personal and political...',
        recs: [
          {
            title: 'Babel',
            slug: 'babel',
      ...
      {
        heading:
          'If you loved the clan war — organized crime as politics, violence as the language of power...',
        recs: [
          {
            title: 'Six of Crows',
            slug: 'six-of-crows',
  ...
  },
  {
    ...
    aspects: [
      ...
      {
        heading:
          'If you loved the banter — humour that earns every moment of genuine emotion...',
        recs: [
          {
            title: 'The Lies of Locke Lamora',
            slug: 'the-lies-of-locke-lamora',
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Mercedes Lackey published Arrows of the Queen in 1987 and created a template that has never quite been replicated. The Companion bond — a magical white horse who chooses its Herald, not the other way around — is one of the most emotionally resonant relationships in fantasy fiction, because of what the choosing means: unconditional recognition. Rolan sees who Talia actually is and picks her specifically, and for a girl fleeing an abusive Holding where she was invisible and unwanted, that moment is the emotional fulcrum of the entire series. The Collegium — where young Heralds-in-training live, study, and grow into a found family — is built with genuine warmth, the sense that this world is worth protecting because the people in it actually care for each other. Lackey's Gifts (psychic powers, each unique to its bearer) give the magic system an intimate, character-specific quality: Talia's Empathy is not just an ability, it is a metaphor for what she does for everyone around her. Lackey is often described as writing comfort fantasy, which undersells what she is actually doing — she writes fantasy where kindness is a form of power, where belonging is earned rather than given, and where the hardest thing a person can do is let themselves be cared for.",
    },
    aspects: [
      {
        heading:
          'If you loved the Companion bond — the magical being who chooses you specifically, a partnership deeper than any human relationship...',
        recs: [
          {
            title: 'Dragonflight',
            slug: 'dragonflight',
      ...
      {
        heading:
          "If you loved Lackey's emotional world-building — fantasy where kindness is a form of power and a world worth saving is one where people genuinely care for each other...",
        recs: [
          {
            title: 'The Goblin Emperor',
            slug: 'the-goblin-emperor',
  ...
  },
  {
    ...
    source: {
      ...
      why_people_love:
        "Ilona Andrews solved the core tension of urban fantasy with Kate Daniels: the protagonist has to be powerful enough to matter, vulnerable enough to be in real danger, and funny enough that you enjoy spending time in her head. Kate is all three simultaneously, and she delivers them through a first-person voice so consistent and distinctive that it never wavers across ten books. The world-building hook — magic and technology alternate in waves, with Atlanta lurching between modernity and medieval conditions depending on which is currently ascendant — is one of the genuinely original ideas in early 2000s fantasy, and it gives the city a texture that no other urban fantasy setting quite replicates. The Pack, with Curran as the Beast Lord, provides the supernatural politics with a center of gravity that plays against Kate throughout: the shapeshifters are not the enemy but not quite the ally, a power structure she has to navigate rather than fight or join. What keeps readers through ten books is the combination of Kate's voice — dry, precise, occasionally terrified, always competent — and the slow burn with Curran, which is one of the most carefully earned romantic relationships in genre fiction: two apex predators who spend three books refusing to admit they respect each other before they admit anything else.",
    },
    aspects: [
      {
        heading:
          "If you loved Kate's voice — the snarky, secretly overpowered mercenary who solves problems with a sword and a dry observation about how badly this is going...",
        recs: [
          {
            title: 'Storm Front',
            slug: 'storm-front',
    ...
    related: [
      { title: 'Books Like Storm Front', slug: 'storm-front' },
      { title: 'Books Like From Blood and Ash', slug: 'from-blood-and-ash' },
      { title: 'Books Like Nevernight', slug: 'nevernight' },
    ],
  },

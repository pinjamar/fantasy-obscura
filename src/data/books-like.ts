...
export const BOOKS_LIKE: BooksLikeEntry[] = [
    ...
    aspects: [
      {
        ...
        recs: [
          ...
          },
          {
            ...
            cover_url: 'https://covers.openlibrary.org/b/isbn/9780425284049-L.jpg',
            darkness_level: 4,
            standalone: false,
            ...
            tags: ['Assassin Convent', 'Prodigy Protagonist', 'Dark Magic', 'Underdog', 'Female Warrior'],
            warning: 'Violence, dark themes',
            amazon_url: 'https://www.amazon.com/s?k=Red+Sister+Mark+Lawrence',
            bookshop_url: 'https://bookshop.org/search?keywords=Red+Sister+Mark+Lawrence',
          },
        ],
      },
      {
    ...
    recommendations: [
      {
        ...
        darkness_level: 2,
        heat_level: null,
        tags: ['Cozy Fantasy', 'Kind Protagonist', 'Found Family', 'Low Stakes', 'Political Warmth'],
      ...
      },
      {
        ...
        darkness_level: 2,
        heat_level: 'Closed Door',
        tags: ['Cozy Fantasy', 'Found Family', 'Queer Romance', 'Death & Grief', 'Warm Tone'],
        ...
        standalone: true,
        audiobook: true,
        amazon_url: 'https://www.amazon.com/s?k=Under+the+Whispering+Door+TJ+Klune',
        bookshop_url: 'https://bookshop.org/search?keywords=Under+Whispering+Door+TJ+Klune',
      },
      {
        ...
        bookshop_url: "https://bookshop.org/search?keywords=Howl's+Moving+Castle+Diana+Wynne+Jones",
      },
    ],
    related: [
    ...
    recommendations: [
      {
        ...
        darkness_level: 3,
        heat_level: 'Closed Door',
        tags: ['Female Protagonist', 'Political Intrigue', 'Fairy Tale Retelling', 'Standalone Epic', 'Literary'],
      ...
      },
      {
        ...
        darkness_level: 4,
        heat_level: 'Closed Door',
        tags: ['Female Protagonist', 'Historical Epic', 'Military Fantasy', 'Identity', 'Queer'],
      ...
      },
      {
        ...
        darkness_level: 3,
        heat_level: 'Closed Door',
        tags: ['Female Protagonist', 'Russian Folklore', 'Atmospheric', 'Magic System', 'Standalone Entry Point'],
        ...
        bookshop_url: 'https://bookshop.org/search?keywords=Bear+and+the+Nightingale+Katherine+Arden',
      },
    ],
    related: [
      { title: 'Books Like The Way of Kings', slug: 'the-way-of-kings' },
    ...
    recommendations: [
      {
        ...
        darkness_level: 2,
        heat_level: 'Closed Door',
        tags: ['Atmospheric', 'Magical World', 'Beautiful Prose', 'Mystery', 'Standalone'],
      ...
      },
      {
        ...
        darkness_level: 2,
        heat_level: 'Closed Door',
        tags: ['Labyrinthine World', 'Books Within Books', 'Literary Fantasy', 'Mystery', 'Atmospheric'],
    ...
    recommendations: [
      {
        ...
        darkness_level: 1,
        heat_level: 'Sweet Romance',
        tags: ['Cozy Fantasy', 'Classic', 'Witty', 'Found Family', 'Kind Protagonist'],
      ...
      },
      {
        ...
        darkness_level: 2,
        heat_level: 'Open Door',
        tags: ['Found Family', 'Character-Driven', 'Hopepunk', 'Ensemble Cast', 'Warmth'],
        why: 'A tunnelling ship and its crew spend a year travelling to a dangerous job, and the book is entirely about what happens to a small community of people who genuinely care about each other. Chambers does not write plot-driven books — she writes character-driven found-family stories where the world is interesting but the relationships are the point. The emotional register is the same as Goblin Emperor: a belief that kindness is not weakness, that found families are real families, and that quiet moments of connection are worth as much as any dramatic arc. Caveat: science fiction, not fantasy — the setting is a spaceship, not a palace.',
        standalone: false,
        audiobook: true,
        amazon_url: 'https://www.amazon.com/s?k=The+Long+Way+to+a+Small+Angry+Planet+Becky+Chambers',
        bookshop_url: 'https://bookshop.org/search?keywords=Long+Way+Small+Angry+Planet+Becky+Chambers',
      },
    ],
    related: [
      { title: 'Books Like Legends & Lattes', slug: 'legends-and-lattes' },
  ...
  },
  {
    ...
    source: {
      ...
      series: 'The Wheel of Time',
      series_number: 1,
      tropes: ['Chosen One', 'Epic Quest', 'Magic System', 'Multiple POVs', 'World-Ending Stakes', 'Found Family', 'Female Magic Institution', 'Political Intrigue'],
    ...
    aspects: [
      {
        heading: 'If you loved the meticulous magic system and the depth of world-building...',
        recs: [
          {
            title: 'The Way of Kings',
            author: 'Brandon Sanderson',
            ...
            tags: ['Magic System', 'Epic World-Building', 'Multiple POVs', 'Same Author (completed WoT)', 'Massive Scope'],
            amazon_url: 'https://www.amazon.com/s?k=The+Way+of+Kings+Brandon+Sanderson',
            bookshop_url: 'https://bookshop.org/search?keywords=The+Way+of+Kings+Sanderson',
          },
          {
            ...
            tags: ['Maximum Scope', 'Deep Lore', 'Military Fantasy', 'No Hand-Holding', 'Complete Series'],
      ...
      {
        heading: 'If you loved the multi-POV ensemble and watching a cast grow across many books...',
        recs: [
          {
            title: 'A Game of Thrones',
            author: 'George R.R. Martin',
            ...
            tags: ['Multi-POV Epic', 'Political Intrigue', 'No Safe Characters', 'Grimdark', 'Same Ambition'],
            ...
            bookshop_url: 'https://bookshop.org/search?keywords=A+Game+of+Thrones+George+RR+Martin',
          },
          {
            title: 'The Dragonbone Chair',
            author: 'Tad Williams',
            cover_url: 'https://covers.openlibrary.org/b/isbn/9780886773786-L.jpg',
            darkness_level: 3,
            standalone: false,
            ...
            tags: ['Direct WoT Ancestor', 'Epic Quest', 'Multi-POV', 'Slow Build', 'Rich Mythology'],
            amazon_url: 'https://www.amazon.com/s?k=The+Dragonbone+Chair+Tad+Williams',
            bookshop_url: 'https://bookshop.org/search?keywords=The+Dragonbone+Chair+Tad+Williams',
          },
        ],
      },
      {
        heading: 'If you loved the Aes Sedai and the idea of women holding real institutional power...',
        recs: [
          {
            title: 'Mistborn: The Final Empire',
            author: 'Brandon Sanderson',
            ...
            tags: ['Female Protagonist', 'Rigorous Magic System', 'Heist Fantasy', 'Chosen One', 'Same Author (completed WoT)'],
          ...
          },
          {
            ...
            tags: ['Female Protagonist', 'Dark Power', 'Military School', 'Transgressive Magic', 'Historical Basis'],
    ...
    recommendations: [
      {
        ...
        darkness_level: 2,
        heat_level: 'Sweet Romance',
        tags: ['Magic System Depth', 'Legendary Protagonist', 'University Setting', 'First Person Narrative'],
      ...
      },
      {
        ...
        darkness_level: 4,
        heat_level: null,
        tags: ['Grimdark', 'Multi-POV', 'Political Realism', 'Subverted Heroism', 'Complete Trilogy'],
      ...
      },
      {
        ...
        darkness_level: 4,
        heat_level: 'Closed Door',
        tags: ['Chosen One', 'Brutal Training', 'Epic Scope', 'Fast-Paced', 'Complete Saga'],
  ...
  },
  {
    ...
    source: {
      ...
      series: 'A Song of Ice and Fire',
      series_number: 1,
      tropes: ['Multi-POV', 'Political Intrigue', 'No Safe Characters', 'Morally Grey Cast', 'Grimdark', 'War & Conflict', 'Subverted Heroism', 'Dragons'],
    ...
    aspects: [
      {
        heading: 'If you loved the political realism and the no-safe-characters stakes...',
        recs: [
          {
            title: 'The Blade Itself',
            author: 'Joe Abercrombie',
            ...
            series: 'The First Law',
            series_number: 1,
            series_label: 'Series (trilogy + 4 standalones + sequel trilogy, all complete)',
            audiobook: true,
            ...
            tags: ['Political Realism', 'No Safe Heroism', 'Multi-POV', 'Grimdark', 'Complete Series'],
          ...
          },
          {
            ...
            tags: ['Political Machination', 'No Safe Heroism', 'Economic Realism', 'Moral Cost', 'Grimdark'],
            warning: 'Queerphobia as systemic theme, emotional devastation',
            amazon_url: 'https://www.amazon.com/s?k=The+Traitor+Baru+Cormorant+Seth+Dickinson',
            bookshop_url: 'https://bookshop.org/search?keywords=Traitor+Baru+Cormorant+Dickinson',
          },
      ...
      {
        heading: 'If you loved the world-spanning multi-POV structure and the depth beneath the story...',
        recs: [
          {
            title: 'Gardens of the Moon',
            author: 'Steven Erikson',
            ...
            tags: ['Maximum Scale', 'Multi-POV', 'Deep Lore', 'No Safe Heroism', 'Complete Series'],
          ...
          },
          {
            ...
            tags: ['Epic Scale', 'Multi-POV', 'Completed Series', 'Political Complexity', 'Rich World'],
            amazon_url: 'https://www.amazon.com/s?k=The+Eye+of+the+World+Robert+Jordan',
            bookshop_url: 'https://bookshop.org/search?keywords=The+Eye+of+the+World+Robert+Jordan',
          },
        ],
      },
      {
        heading: 'If you loved the morally grey characters whose choices compound into catastrophe...',
        recs: [
          {
            title: 'The Poppy War',
            author: 'R.F. Kuang',
            ...
            tags: ['Moral Erosion', 'No Safe Heroism', 'Dark Power', 'War & Atrocity', 'Female Protagonist'],
            warning: 'War atrocity, genocide, drug addiction, graphic violence',
            amazon_url: 'https://www.amazon.com/s?k=The+Poppy+War+RF+Kuang',
            bookshop_url: 'https://bookshop.org/search?keywords=The+Poppy+War+RF+Kuang',
          },
          {
            ...
            tags: ['Anti-Hero', 'Moral Darkness', 'First-Person Villain', 'Grimdark', 'Complete Trilogy'],
    ...
    recommendations: [
      {
        ...
        darkness_level: 2,
        heat_level: 'Sweet Romance',
        tags: ['Literary Prose', 'Legendary Protagonist', 'Deep Magic System', 'Same Reader Demographic'],
      ...
      },
      {
        ...
        darkness_level: 4,
        heat_level: null,
        tags: ['Political Scheming', 'Morally Grey', 'Witty Dialogue', 'World With History', 'Found Family'],
        ...
        audiobook: true,
        amazon_url: 'https://www.amazon.com/s?k=The+Lies+of+Locke+Lamora+Scott+Lynch',
        bookshop_url: 'https://bookshop.org/search?keywords=The+Lies+of+Locke+Lamora+Scott+Lynch',
      },
      {
        title: 'Red Rising',
        author: 'Pierce Brown',
        ...
        darkness_level: 4,
        heat_level: 'Closed Door',
        tags: ['No Safe Characters', 'Political Scheming', 'Epic Scope', 'Complete Saga', 'Fast-Paced'],

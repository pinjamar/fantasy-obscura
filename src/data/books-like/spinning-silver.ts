...
export const spinningSilver: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "Spinning Silver does something most fairy tale retellings don't — it earns its cleverness. Miryem doesn't win because she's special or chosen; she wins because she pays attention, understands how systems work, and refuses to accept the terms she's given. Novik splits the narrative between three women (Miryem the moneylender's daughter, Wanda the peasant, Irina the noblewoman) and makes all three equally compelling, which almost never works." },
      { type: 'labeled', label: 'The Staryk King:', text: "He operates on fairy-tale logic that the book follows with unusual rigor — there is no cheating his rules, only finding the gap. What makes him work as a love interest is precisely that Novik refuses to make him more human than he is. He is alien, cold, and bound by the same logic he imposes on everyone else. The romance develops entirely through negotiation and grudging respect, which is a more interesting foundation than most fantasy romances manage." },
      { type: 'paragraph', text: "The Slavic winter setting is immersive without being overwhelming, and the three-POV structure lets Novik show how the same crisis looks from inside different systems of power — merchant, peasant, and noble. Each woman uses the only tools her position gives her, and Novik is scrupulously fair about what those tools cost." },
      { type: 'warning', text: "Spinning Silver is a standalone — it closes completely, no sequels. The Jewish cultural specificity is handled with care and matters to the story rather than serving as background detail. Readers who want a single love-interest POV rather than three alternating perspectives may find the structure takes adjusting to, but the three-POV model is the book's greatest structural strength." },
    ],
  },
  aspects: [
    {

  ...
  aspects: [
    {
      ...
      recs: [
        ...
        },
        {
          ...
          audiobook: true,
          note: `The most ambitious modern attempt at Tolkien's scale. Sanderson builds Roshar with the same density of history, culture, and cosmology: in-world documents, epigraphs, and flashback chapters that gradually reveal a world with thousands of years of buried truth. The ensemble cast is distinct and well-developed, and the threat (the Desolations returning) operates on the same ancient-evil timescale as Sauron.`,
          caveat: "Sanderson's prose is functional rather than lyrical; if you came to Tolkien primarily for the writing, this will feel different, but if you came for the world and the stakes, this delivers both.",
          tags: [
            'Epic World-Building',
            'Ancient Threat',
            'Multiple POVs',
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          caveat: "800 pages of setup before the plotlines converge, and the multiple-culture POV structure means no single character gets Frodo's amount of close focus.",
          tags: [
            'Dragon Lore',
            'Multiple POVs',
            'Deep History',
      ...
      recs: [
        {
          ...
          caveat: "Under 200 pages against Fellowship's much larger scale, and Ged's journey is solitary rather than a fellowship of companions.",
          tags: [
            'Classic Fantasy',
            'Humble Origins',
            'Moral Weight',
      ...
      recs: [
        {
          ...
          standalone: true,
          audiobook: true,
          note: `Clarke spent ten years writing this novel, and it shows. Two English magicians in the Napoleonic era argue over the proper use of magic while a Faerie king interferes with both of them, but the real subject is the world that existed before living memory, when magic was everywhere and the Raven King ruled northern England. The footnotes carry entire subplots about ancient magical history, the prose sounds like it was written in the period it depicts, and the sense of a vast secondary mythology operating behind the action is exactly what Tolkien readers respond to.`,
          caveat: "A Regency comedy-of-manners register rather than Tolkien's mythic-epic one, and the second half is considerably darker and stranger than the first.",
          tags: [
            'Historical Fantasy',
            'Ancient Magic',
            'Literary Prose',

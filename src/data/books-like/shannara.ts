...
export const shannara: BooksLikeEntry = {
  slug: 'shannara',
  source: {
    ...
    answer_line:
      "If you loved Shannara for the pure quest fantasy: the chosen bloodline, the ancient artifact, the druid guide, the world worth saving: start with The Fellowship of the Ring, The Hobbit, and Assassin's Apprentice.",
    why_people_love:
      "The Sword of Shannara was published in 1977 as the first fantasy novel to debut on the New York Times bestseller list, and it launched Del Rey's entire fantasy publishing line. Yes, it wears its Tolkien debt openly: Shea Ohmsford and Flick are as close to Frodo and Sam as you can get without being derivative, and Allanon is unmistakably Gandalf in a darker coat. But that criticism misses what Brooks was doing: he was translating the emotional grammar of Tolkien into a template that could run indefinitely, a world with enough room for generations of heroes and decades of stories. The Ohmsford bloodline becomes the emotional throughline: a family that carries responsibility it never asked for, across trilogy after trilogy, in a world that keeps darkening and keeps needing saving. The Elfstones of Shannara, the second book, is where Brooks stepped fully out of Tolkien's shadow and wrote something genuinely his own: the Ellcrys, the Forbidding, Wil and Amberle, and an ending with real weight. Shannara readers come back for the combination of scope and safety: a world that is genuinely epic but whose moral framework is clear enough that you can invest without bracing yourself for everyone you love to die.",
    why_people_love_rich: [
      { type: 'paragraph', text: "The Sword of Shannara was published in 1977 as the first fantasy novel to debut on the New York Times bestseller list, and it launched Del Rey's entire fantasy publishing line. Yes, it wears its Tolkien debt openly: Shea Ohmsford and Flick are as close to Frodo and Sam as you can get without being derivative, and Allanon is unmistakably Gandalf in a darker coat. But that criticism misses what Brooks was doing: he was translating the emotional grammar of Tolkien into a template that could hold an entire world." },
      { type: 'labeled', label: 'The Elfstones:', text: "The second book, The Elfstones of Shannara, is where Brooks stepped fully out of Tolkien's shadow and wrote something genuinely his own. The Ellcrys, the Forbidding, Wil and Amberle, and an ending with real emotional weight, give the Shannara world its emotional anchor. Most readers who came back for every subsequent trilogy came back because of Elfstones. Read it as the real entry point if the Sword's familiarity feels too close to its source." },
      { type: 'paragraph', text: "The Ohmsford bloodline becomes the engine: a family that carries responsibility it never asked for, across trilogy after trilogy, in a world that keeps darkening and keeps needing saving. What Brooks offers is scope and safety: genuinely epic stakes inside a moral framework clear enough that you can invest without bracing yourself for everyone you love to die. That combination, rare in contemporary fantasy, is what kept readers with the series across forty years and well over thirty novels." },
      { type: 'warning', text: "The original trilogy (Sword, Elfstones, Wishsong) is the essential reading. Brooks continued the world across many trilogies and the quality is uneven; most readers recommend stopping after the Heritage of Shannara quadrology if you want a natural endpoint. The Sword itself is the weakest entry; if you find it overly familiar, push through to Elfstones before deciding." },
    ],
  },
  aspects: [
    {
      ...
      recs: [
        {
          ...
          caveat: "far denser and more mythologically weighted prose than Brooks's; Tolkien built the template Shannara adapted for an easier, faster read.",
          tags: [
        ...
        },
        {
          ...
          caveat: "a fourteen-book commitment with a much larger cast and far more political complexity than Shannara ever attempts.",
          tags: [
            'Chosen Hero',
            'Dark Lord',
            'Epic Scope',
        ...
        },
        {
          ...
          caveat: "written by a teenage author, so the prose is simpler and the pacing choppier than Brooks's more assured, adult craft.",
          tags: [
            'Farm Boy Hero',
            'Dragon Bond',
            'Dark Empire',
      ...
      recs: [
        {
          ...
          caveat: "lighter and gentler than Shannara throughout; the stakes are real but the tone never approaches the darker moments of Brooks's trilogy.",
          tags: [
            'Classic Adventure',
            'Accessible',
            'Warmhearted',
        ...
        },
        {
          ...
          caveat: "much slower-paced and more politically dense than Shannara; the first act is patient world-building rather than an early quest launch.",
          tags: [
            'Classic Epic Fantasy',
            'Coming-of-Age',
            'Deep World',
      ...
      recs: [
        {
          ...
          caveat: "considerably darker and more psychologically demanding than Shannara, with a first-person voice that dwells in grief and isolation.",
          tags: [
            'Generational Saga',
            'Inherited Burden',
            'Deep World',
        ...
        },
        {
          ...
          caveat: "the trilogy has been unfinished for over a decade, unlike Shannara's completed original trilogy.",
          tags: [
            'Immersive World',
            'Literary Fantasy',
            'Gifted Hero',

...
export const theVerySecretSocietyOfIrregularWitches: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "The Very Secret Society of Irregular Witches is the book people describe as 'comfort read of the year' — the one they recommend to anyone who needs to feel held. Mika Moon has grown up told that witches must never gather, so she has spent her whole life performing normalcy and keeping her distance from anyone who might matter. When she's hired to secretly tutor three young witches hidden in a rambling countryside house full of opinionated staff, she doesn't expect to find the family she never knew she needed." },
      { type: 'labeled', label: 'Mika:', text: "She is a person who has made herself a stranger to belonging — who learned so early that connection was dangerous that she has made the loneliness feel normal. Mandanna builds her isolation with enough specificity that the reader understands it from the inside, which is how the household's slow accumulation of warmth lands: you feel Mika starting to let herself want things. The grumpy librarian with his dry wit, the older women with their decades of history, the children who are chaos in human form — they come for her in exactly the right order." },
      { type: 'paragraph', text: "Mandanna builds warmth slowly and then delivers it all at once. The magic is gentle and present throughout — never world-ending, always personal. The romance is the second thing; the found family is the first. This is a book for anyone who has ever felt that belonging was something that happened to other people." },
      { type: 'warning', text: "The Very Secret Society of Irregular Witches has almost no external conflict — the stakes are low by design, and the plot is organised around emotional beats rather than threat. Readers who need a villain or a ticking clock will find this frustrating. The cozy atmosphere is the point, not a wrapper for something darker. The romance is closed door throughout. This is comfort reading in the truest sense: gentle, warm, and built to make you feel held." },
    ],
  },
  aspects: [
    {
    ...
    {
      heading: 'If you loved Mika being a lone witch who finally finds her coven…',
      recs: [
        {
          title: 'Practical Magic',
          author: 'Alice Hoffman',
          cover_url: 'https://covers.openlibrary.org/b/isbn/9780425163023-L.jpg',
          darkness_level: 2,
          heat_level: 'Closed Door',
          standalone: true,
          audiobook: true,
    ...
    {
      heading: 'If you loved the slow-burn romance and the cozy, unhurried warmth…',
      recs: [
        {
        ...
        },
        {
          ...
          cover_url: 'https://covers.openlibrary.org/b/isbn/9780593549827-L.jpg',
          darkness_level: 1,
          heat_level: 'Open Door',
          standalone: true,
          audiobook: true,

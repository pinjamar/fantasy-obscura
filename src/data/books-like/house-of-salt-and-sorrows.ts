...
export const houseOfSaltAndSorrows: BooksLikeEntry = {
  ...
  source: {
    ...
    answer_line:
      'If you loved House of Salt and Sorrows for the creeping gothic dread, the Twelve Dancing Princesses retelling structure, and the sense that something impossibly beautiful is also killing everyone around the heroine, start with Caraval, House of Hollow, and Spinning Silver.',
    why_people_love:
  ...
  aspects: [
    ...
    {
      heading:
        'If you loved the fairy tale darkness and the female-centred story: horror turned inward on the women navigating it...',
      recs: [
        {

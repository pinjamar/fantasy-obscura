...
export const bloodSong: BooksLikeEntry = {
  slug: 'blood-song',
  source: {
    title: 'Blood Song',
    author: 'Anthony Ryan',
    ...
    why_people_love_rich: [
      ...
      },
      {
        type: 'labeled',
        label: 'The Frame:',
        text: "Vaelin tells his story to a historian while imprisoned, which means you are always reading against the weight of what has already happened. Older Vaelin in chains is the result of the training arc you are reading. Every victory in the Order feels different when you hold that in mind.",
      },
      {
        type: 'paragraph',
        text: "Vaelin is a rare grimdark-adjacent protagonist: genuinely good, not defined by trauma or cynicism, but operating in a world that will test that goodness with full seriousness. Blood Song sits in the unusual position of being grimdark-adjacent without the mandatory nihilism. That makes it the entry point back into dark epic fantasy for readers who bounced off Abercrombie or Cook's moral bleakness.",
      },
      {
        type: 'warning',
  ...
  aspects: [
    {
      heading:
        'If you loved the frame narrative (Vaelin in captivity telling his own legend, the melancholy of knowing the ending looms over the training arc)...',
      recs: [
        {
    ...
    {
      heading:
        'If you loved the military brotherhood (the Sixth Order as found family, the loyalty between soldiers who trained together)...',
      recs: [
        {
    ...
    {
      heading:
        'If you loved the training arc (the brutal initiation, earning mastery through years of hardship rather than a sudden power-up)...',
      recs: [
        {
          title: 'Red Sister',
  ...
  recommendations: [
    ...
    },
    {
      ...
      why: "Malazan is the military brotherhood and epic scope of Blood Song pushed to the absolute limit. Gardens of the Moon drops you into an imperial military campaign with almost no orientation and trusts you to piece together a world of staggering complexity. The Bridgeburners (Erikson's elite soldier unit) have the same band-of-brothers dynamic as the Sixth Order, and the series' treatment of what soldiers endure for empires that don't deserve them is the most sustained in fantasy. The first book throws you in cold. Push through.",
      standalone: false,
      audiobook: true,
      amazon_url:

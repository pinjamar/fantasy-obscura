...
export const percyJackson: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      ...
      { type: 'paragraph', text: "The quests are structured like road trips — three kids, a prophecy, a deadline — and Riordan keeps them moving. Each book adds a new piece of the Olympian world while the central mystery builds toward a payoff that earns the emotional weight it's been accumulating. What readers are actually chasing isn't Greek mythology specifically — it's the feeling of a real, ancient world hidden just behind the world you know." },

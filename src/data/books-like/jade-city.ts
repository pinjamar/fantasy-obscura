...
export const jadeCity: BooksLikeEntry = {
  slug: 'jade-city',
  source: {
    title: 'Jade City',
    author: 'Fonda Lee',
    ...
    answer_line:
      'If you loved Jade City for the Kaul family loyalty, the jade magic tied to cultural identity, and the clan war that escalates into something unstoppable, start with The Grace of Kings, Babel, and Six of Crows.',
    why_people_love:
    ...
    why_people_love_rich: [
      {
        type: 'paragraph',
        text: "Jade City works because Fonda Lee understands that the most devastating conflicts are the ones inside families. The No Peak clan war against the Mountain is political and violent, but what makes it land is the Kauls: Lan holding the clan together through duty he never wanted, Hilo leading with violence because that is what the clan needs, Shae returning from self-imposed exile.",
      },
      {
        type: 'labeled',
        label: 'The Jade:',
        text: "Not just power. It is what makes Green Bones who they are, inseparable from Kekonese identity, and the cost of wearing too much is as much psychological as physical. Lee makes the magic system a metaphor for cultural inheritance without ever letting it become only a metaphor.",
      },
      {
        type: 'paragraph',
        text: "Lee refuses to simplify the rival clan into pure villains. The Mountain has its own logic, its own loyalty, and its own cost. The organized crime energy (territory, tribute, enforcers) is the vehicle for exploring what power requires of the people who hold it.",
      },
      {
        type: 'warning',
        text: "The series spans decades and three books, and the scope expands in ways that can be disorienting. This is an investment series: the first book sets up losses that the second and third books pay off. Readers who want complete arcs within each volume should know the series rewards patience across all three.",
      },
    ],
  },
  aspects: [
    {
      heading:
        'If you loved the Kaul family: people bound together by duty, loyalty that costs more than it gives...',
      recs: [
        {
      ...
      recs: [
        {
          ...
          caveat:
            'Darker and more overtly political than Jade City; this is also a critique of colonialism and empire, not just a fantasy with a cost-magic system.',
          tags: [
    ...
    {
      heading:
        'If you loved the clan war: violence as the language of power, and territory held only as long as you can defend it...',
      recs: [
        {
          title: 'Six of Crows',
          slug: 'six-of-crows',
        ...
        },
        {
          ...
          caveat:
            'Science fiction setting and much higher darkness; the body count and brutality are significantly greater than Jade City, and this is a caste war rather than organized crime.',
          tags: [
            'Rival Factions',
            'Political Violence',
            'Strategic Combat',

...
export const fromBloodAndAsh: BooksLikeEntry = {
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          series_label: 'Series (4 books)',
          audiobook: true,
          note: "The same structural pleasure as Hawke — a love interest who presents as cold, ruthless, and dangerous, whose public persona is entirely a mask. Hades is the God of the Underworld running his kingdom from the shadows, and Persephone cannot grow a single living thing despite being the Goddess of Spring. The inversion is clever and the tension is built on real dynamic rather than proximity alone. The heat is explicit and arrives early. Caveat: the world-building is lighter than FBAA and the mythology is used loosely — you're here for the enemies-to-lovers arc, not a faithful Greek retelling.",
          tags: [
            'Greek Mythology',
            'Morally Grey Love Interest',
            'Hidden Identity',
          ...
          bookshop_url:
            'https://bookshop.org/search?keywords=A+Touch+of+Darkness+Scarlett+St+Clair&affiliate=122720',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          series_label: 'Series (trilogy)',
          audiobook: true,
          note: "A soldier discovers she has a rare power that makes her the key to saving her country — and the Darkling, the most powerful person in the kingdom, takes a very specific interest in her. The love interest's hidden agenda and the slow revelation of what he actually wants mirrors the Hawke dynamic closely. Caveat: significantly lower heat and more YA in tone; the romance is slow-burn and secondary to the political plot. The Darkling is one of the most discussed morally grey love interests in fantasy.",
          tags: [
            'Chosen One',
            'Morally Grey Love Interest',
            'Hidden Agenda',

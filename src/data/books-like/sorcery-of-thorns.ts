...
export const sorceryOfThorns: BooksLikeEntry = {
  ...
  source: {
    ...
    answer_line:
      'If you loved Sorcery of Thorns for the sentient magical grimoires, the gothic library atmosphere, and the slow-burn enemies-to-lovers between Elisabeth and Nathaniel, start with The Invisible Library, Uprooted, and The Night Circus.',
    why_people_love:
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "Sorcery of Thorns works because it understands that books are not just containers for stories: in Rogerson's world, they are the stories, alive and dangerous and capable of destroying you if you love them wrong. Elisabeth is one of the best protagonists in YA fantasy: competent, direct, genuinely brave in the physical sense rather than the chosen-one sense, and completely unprepared for a sorcerer who is not what she was told." },
      { type: 'labeled', label: 'Nathaniel and Silas:', text: "The sharp-tongued aristocrat hiding grief behind performance, and the ancient demon who chose loyalty as a form of love: they are the real draws of the book, as individuals and as a pair. Rogerson builds their relationship with care: the demon who serves the sorcerer is genuinely devoted in ways that are strange and sad and not quite human, and the sorcerer's performance of detachment is transparent enough that you feel the gap between who he is and who he presents himself as on every page." },
      { type: 'paragraph', text: "The gothic atmosphere is consistent and immersive: this is a book that smells like old paper and candlelight. The sentient grimoires that can tear their readers apart if mishandled give the library setting genuine stakes rather than cosy atmosphere, and the mystery of who is transforming grimoires into demons gives the plot its momentum. Rogerson builds her world through what happens rather than through exposition." },
      { type: 'warning', text: "Sorcery of Thorns is YA, and the romance stays closed-door. If you are coming for heat, this is not it: the tension is in the restraint, the almost-touches, the things unsaid. The tone is gothic and immersive rather than dark: the threat level is real but the book maintains its sense of wonder about its own world throughout. Standalone, complete." },
    ],
  },
  aspects: [
    {
      ...
      recs: [
        {
          ...
          caveat: "the romance is quieter and less earned than SoT's. This is a book about atmosphere and magic first, characters second. Standalone.",
          tags: [
            'Gothic Atmosphere',
            'Slow Burn',
            'Dark Magic',

...
export const thornhedge: BooksLikeEntry = {
  slug: 'thornhedge',
  source: {
    title: 'Thornhedge',
    author: 'T. Kingfisher',
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "Thornhedge is a Sleeping Beauty retelling told from the wrong side of the hedge. The knight arrives to break the curse, the princess sleeps inside — but Toadling, the toad-person who has guarded the thorns for centuries, knows what the knight doesn't: the princess is not what the fairy tales promise. Kingfisher builds the horror through information asymmetry that is also moral asymmetry: the reader understands what Toadling understands, and the knight's kindness and good intentions are exactly what make him dangerous." },
      { type: 'labeled', label: 'Toadling:', text: "She has been doing the right thing alone for so long that she can barely remember what it cost her. Kingfisher gives her a specific inner life — genuinely fond of the knight, deeply exhausted by centuries of vigilance, carrying a sacrifice that no one can see or acknowledge because acknowledging it would end everything. The tragedy isn't dramatic; it's accumulated. Every interaction is weighted by what Toadling knows and cannot say, and Kingfisher writes that weight with a restraint that makes it heavier, not lighter." },
      { type: 'paragraph', text: "The horror is atmospheric and entirely felt — never explicit, always present, building through accumulation. Kingfisher earns her ending in about 120 pages: compact, precisely constructed, nothing wasted. The book works because of what is withheld: the protagonist who cannot explain herself, the villain who cannot speak for herself, and a knight who will never fully understand what he walked into. The final paragraphs will stay with you." },
      { type: 'warning', text: "Thornhedge is a novella — approximately 120 pages — built on fairy tale dread rather than conventional horror. There is no monster in the traditional sense; the darkness is existential and accumulated across centuries. The ending is tragic, deliberately, and Kingfisher does not soften it. Readers who need a hopeful resolution should approach with caution. This is not a cozy fairy tale retelling — it is a book about sacrifice and the weight of things that cannot be explained." },
    ],
  },
  aspects: [
    {
    ...
    {
      heading: 'If you loved the dark folkloric atmosphere and the quiet, pervasive dread…',
      recs: [
        {
    ...
    {
      heading: 'If you loved the compact novella form — unsettling, precise, and complete…',
      recs: [
        {
          title: 'Piranesi',
          slug: 'piranesi',

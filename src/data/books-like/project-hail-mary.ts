...
export const projectHailMary: BooksLikeEntry = {
  ...
  source: {
    ...
    answer_line:
      "If you loved Project Hail Mary for Rocky, for Grace's humor while solving impossible problems, and for the amnesia structure that reveals the mission piece by piece, start with The Long Way to a Small Angry Planet, The Martian, and Dark Matter.",
    why_people_love:
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "Project Hail Mary does something most hard sci-fi doesn't attempt: it makes the science feel like play. Ryland Grace doesn't explain physics at you. He works through it the way a curious, slightly caffeinated person actually thinks, and the pleasure of the book is following that thinking in real time. The amnesia structure works as pacing: Grace recovering his memories alongside the reader is the reader being recruited into caring about a mission whose stakes only become clear once you're already invested." },
      { type: 'labeled', label: 'Rocky:', text: "An alien whose biology, communication, and emotional register are genuinely different from anything human, and the book spends its second half constructing a friendship across that gap: methodically, believably, through shared problem-solving rather than sentiment. Rocky is why the book exists. Weir builds the emotional weight of that friendship by making the communication problem real before he makes it moving." },
      { type: 'paragraph', text: "The tone is relentlessly optimistic in a way that isn't naive (people die, the situation is genuinely dire) but the book's fundamental argument is that intelligence and goodwill can solve things, and it commits to that argument all the way to the end. Readers who finished it and felt gutted and happy simultaneously were experiencing something real. The ending is the best in Weir's work." },
      { type: 'warning', text: "The amnesia structure means the first fifty pages are deliberately disorienting. Stay with it. The book is standalone and complete. The Martian is the closest companion read (same author, same voice, same problem-solving approach); readers who loved the alien friendship specifically will find less of that in Weir's other work, as Rocky is unique to this book." },
    ],
  },
  aspects: [
    {
      ...
      recs: [
        {
          ...
          caveat: "almost no plot in the conventional sense; this is character and texture first, and the pace is gentle. But if Rocky was your reason for reading, this is your book.",
          tags: [
            'Alien Crew',
            'Found Family',
            'Optimistic Sci-Fi',
      ...
      recs: [
        {
          ...
          caveat: "No alien friendship and no amnesia structure: this is survival science pure, without the emotional gut-punch of the ending Weir wrote for Grace.",
          tags: [
            'Same Author',
            'Lone Survivor',
            'Hard Science',
        ...
        },
        {
          ...
          audiobook: true,
          note: "A security robot who has hacked its own governor module and mostly wants to watch TV serials instead of dealing with humans, assigned to protect a survey team that it gradually, reluctantly, starts to care about. The voice is the match: dry, self-deprecating, mission-focused, and surprisingly vulnerable under the competent surface. Murderbot solving problems it didn't ask for while trying to pretend it doesn't have feelings about the people it's protecting is the same emotional register as Grace and Rocky.",
          caveat: "Novellas rather than a novel (fast reads) and the stakes per book are smaller than Hail Mary's humanity-saving mission.",
          tags: [
            'Dry Humor',
            'Found Family',
            'Problem Solving',
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          caveat: "Slower and more introspective, with political intrigue in place of survival-science problem-solving.",
          tags: [
            'Amnesia-Adjacent',
            'Political Intrigue',
            'Lone Ambassador',

...
export const foundation: BooksLikeEntry = {
  slug: 'foundation',
  source: {
    title: 'Foundation',
    author: 'Isaac Asimov',
  ...
  aspects: [
    {
      ...
      recs: [
        ...
        },
        {
          ...
          amazon_url:
            'https://www.amazon.com/s?k=Too+Like+the+Lightning+Ada+Palmer&tag=librariancura-20',
          bookshop_url:
            'https://bookshop.org/search?keywords=Too+Like+the+Lightning+Ada+Palmer&affiliate=122720',
        },
      ],
    },
    {
      ...
      recs: [
        {
          ...
          amazon_url:
            'https://www.amazon.com/s?k=The+Three-Body+Problem+Liu+Cixin&tag=librariancura-20',
          bookshop_url:
            'https://bookshop.org/search?keywords=The+Three-Body+Problem+Liu+Cixin&affiliate=122720',
        },
        {
          ...
          amazon_url:
            'https://www.amazon.com/s?k=The+Dispossessed+Ursula+Le+Guin&tag=librariancura-20',
          bookshop_url:
            'https://bookshop.org/search?keywords=The+Dispossessed+Ursula+Le+Guin&affiliate=122720',
        },
      ],
    },
  ],

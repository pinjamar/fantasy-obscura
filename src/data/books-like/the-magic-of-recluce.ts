...
export const theMagicOfRecluce: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      ...
      {
        type: 'paragraph',
        text: "The novel is slow by modern pacing standards but earns it: the world accumulates detail through action and observation, never through exposition, and by the end it feels genuinely inhabited. The series follows different protagonists in different eras of Recluce's history — readers can treat each book as a standalone entry point into the same world, or read them all and watch the history develop.",
      },
      {
        type: 'warning',
        text: "The pacing is front-loaded with confusion by design — Lerris doesn't know what he is, and Modesitt doesn't soften this. Readers who want their protagonists competent and their magic systems explained in the first few chapters will struggle. The payoff requires trust in the process.",
      },
    ],
  },
  aspects: [
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          audiobook: true,
          note: "Le Guin's magic is rooted in knowing the true name of things — power comes from understanding, not force, which is exactly what Modesitt argues with Order magic. Ged learns at the Roke school of wizardry, makes a catastrophic mistake through impatience and arrogance, and spends the novel reckoning with it. The approach — that magic is earned, costly, and rooted in deep knowledge of the world — matches Recluce's philosophical register better than almost anything else in fantasy. Much shorter and more austere, but spiritually the same book.",
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          audiobook: true,
          note: "Jordan's Wheel of Time begins the same way as Recluce — young people from a quiet place are forced out into a world far larger and more consequential than they understood — and the magic system (the One Power, split along gender lines) has similar philosophical weight: it has rules, it has costs, it is not simply a tool. Jordan's world is more richly detailed than even Recluce's, the series is longer, and the pacing of the opening book mirrors Modesitt's patient approach to world-revelation. Readers who love Recluce for its sense of genuine history and consequence will find Wheel of Time speaks the same language at scale.",
          caveat: "14 books across 30 years, with significant pacing variation in the middle volumes (books 7–10 are widely considered the weakest). Most readers consider the opening trilogy and the ending consistently excellent.",
    ...
    },
    {
      ...
      recs: [
        ...
        },
        {
          ...
          audiobook: true,
          note: "Kaladin's arc in The Way of Kings is the closest contemporary cousin to Lerris's: a young man with abilities he doesn't understand, forced by circumstance rather than choice into a situation that will define him. Kaladin spends most of the first book as a slave-soldier discovering Stormlight before he understands what it is. Sanderson's magic system (Surgebinding) is as systematic as Allomancy; his world (Roshar) has centuries of history that reveals itself through the action. Recluce readers will recognize the instinct: a world that takes itself seriously, magic that has weight, a protagonist who earns every step.",

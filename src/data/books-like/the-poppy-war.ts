...
export const thePoppyWar: BooksLikeEntry = {
  slug: 'the-poppy-war',
  source: {
    title: 'The Poppy War',
    author: 'R.F. Kuang',
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "The Poppy War does something technically extraordinary: it builds a compelling YA-coded fantasy in the first third — military school, prodigy underdog, found family — and then pivots without warning into a war narrative based directly on the Second Sino-Japanese War and the Nanjing Massacre. The result is one of the most viscerally affecting fantasy novels of the last decade. Kuang does not soften her historical source material, and the book is honest about that from the first line of the author's note." },
      { type: 'labeled', label: 'Rin:', text: "A war orphan from the south with shamanic power she was taught to fear — and a protagonist whose arc is not about becoming a hero but about what happens to a person when power and rage have nowhere constructive to go. Kuang refuses the moral clean-up that most fantasy does after its characters commit atrocities: Rin knows what she has done, knows why she did it, and cannot walk it back. Her erosion across three books is one of the most unflinching character studies in the genre." },
      { type: 'paragraph', text: "The first third is the best military-school fantasy since the genre had military-school fantasy. The found family built there makes the second half devastating rather than merely dark: you know these people, which is the point. Kuang is a historian by training and the book functions as historical fiction in fantasy clothing — the parallel to the Nanjing Massacre is explicit and intentional." },
      { type: 'warning', text: "The Poppy War contains extended depictions of wartime atrocity, genocide, sexual violence, and drug addiction. Kuang does not use darkness for atmosphere — she uses it as historical argument. Readers who are not prepared for this should not approach the book. The trilogy escalates in darkness across all three volumes. The first third reads very differently from the second; this tonal shift is the book's central structural choice and not an accident." },
    ],
  },
  aspects: [
    {
      ...
      recs: [
        {
          ...
          caveat: "Jorg is younger than Rin and the book opens with a scene many readers find too extreme. The series demands you sit with a genuinely repellent protagonist.",
          tags: [

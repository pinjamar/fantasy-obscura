...
export const theDarkTower: BooksLikeEntry = {
  slug: 'the-dark-tower',
  source: {
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "The Dark Tower is the book series that refuses to be one thing. Roland Deschain is the last gunslinger in a world that has moved on — a post-apocalyptic Western landscape full of failed magic, ruined technology, and a sun that doesn't feel quite right — and his quest drives eight novels across five decades of King's career. The series connects to nearly everything King has written: The Stand, It, Insomnia, Salem's Lot, The Shining — reading it makes his body of work feel like one enormous interconnected universe with the Tower as its spine." },
      { type: 'labeled', label: 'The Ka-Tet:', text: "Eddie Dean, pulled from 1980s New York; Susannah Dean, from 1960s New York; Jake Chambers, a boy who died and came back; Oy the billy bumbler — people stolen from their lives into Mid-World who form bonds that should be impossible, then are tested at exactly the cost you dreaded. This is King at his best with found-family dynamics: the bonds are built in chapters of motion through a world trying to kill them, and the cost of those bonds is paid in full. Roland is not an easy hero — he chose the Tower over everyone he loved, more than once — and the series never lets him or the reader forget it." },
      { type: 'paragraph', text: "The series is formally strange in ways that become features rather than bugs. King includes himself as a character in the later books. The tonal shifts between volumes are significant: The Gunslinger is lean and mythic; The Drawing of the Three is propulsive; Wizard and Glass is the devastating romantic backstory. Each book is a different kind of novel, which is either the series' greatest strength or its central problem depending on the reader." },
      { type: 'warning', text: "The Dark Tower is eight books and some readers find certain volumes much weaker than others. The ending is divisive and intentionally so — it is not the ending of a book that wanted to reward you, and King wrote it knowing that. Wolves of the Calla and Song of Susannah draw heavily on King's other novels in ways that can feel self-indulgent without that context. The series begins best if you treat The Gunslinger as a novella-length prologue and commit through The Drawing of the Three before deciding." },
    ],
  },
  aspects: [
    {

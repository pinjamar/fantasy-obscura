...
export const powerless: BooksLikeEntry = {
  slug: 'powerless',
  source: {
    title: 'Powerless',
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "Powerless works because Roberts understood that the real threat isn't the Purging Trials — it's the moment Paedyn Gray, entirely without magic in a kingdom that executes the Powerless, is noticed by the prince whose job it is to hunt her kind. The survival mechanics give the book momentum, but the emotional architecture is about two people who cannot afford to feel what they're feeling and cannot stop." },
      { type: 'labeled', label: 'Kai:', text: "A prince who believes in the system he was handed, until the girl who should be his easiest mark keeps refusing to be easy. Roberts writes Kai with real care — his arc is not simply a good person trapped in a bad system but the slower, more honest process of someone whose convictions are worn down by a specific person's specific stubbornness. The slow burn is built almost entirely from proximity and competence-as-attraction." },
      { type: 'paragraph', text: "Paedyn is written as genuinely resourceful rather than secretly special: she survives by reading people, adapting fast, and keeping her panic internal. Roberts doesn't give her a hidden power that saves everything — she gives her intelligence and composure under conditions designed to break her. The tension is credible because the threat is real." },
      { type: 'warning', text: "The slow burn is patient in a way YA romantasy rarely is — the romantic tension builds across the whole book rather than resolving early. The content is closed-door throughout the trilogy. The trilogy is complete, and the second book (Renegade) is where the complexity escalates considerably. Do not read the blurb before finishing Powerless." },
    ],
  },
  aspects: [
    {

...
export const theWheelOfTime: BooksLikeEntry = {
  ...
  source: {
    ...
    answer_line:
      'If you loved The Eye of the World for the meticulous magic system, sprawling world, ensemble cast, and classic epic-fantasy scale, start with The Way of Kings, A Game of Thrones, and Mistborn: The Final Empire.',
  ...
  aspects: [
    {
      ...
      recs: [
        ...
        },
        {
          ...
          caveat: "the first two books are by wide consensus the most challenging entry point in the genre; many readers require a second attempt. Readers who push through consistently call it worth the effort.",
          tags: [
            'Maximum Scope',
            'Deep Lore',
            'Military Fantasy',
      ...
      recs: [
        {
          ...
          caveat: "much shorter and faster-paced than WoT, with a single protagonist rather than Jordan's sprawling ensemble.",
          tags: [
            'Female Protagonist',

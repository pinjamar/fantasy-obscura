...
export const theLiesOfLockeLamora: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "The Lies of Locke Lamora works because Lynch does three things at once that almost no one else manages: he writes a heist that's genuinely clever, a city that feels like it has five hundred years of history behind every alley, and a found family whose loyalty feels earned rather than assumed. Camorr is a Venice analogue built on the ruins of something ancient, stratified by glass-tower architecture the current population cannot replicate, and run by criminal peace treaties that the Gentleman Bastards are about to blow up." },
      { type: 'labeled', label: 'The Gentleman Bastards:', text: "Orphans trained to be criminals by a man who loved them — and the book never lets you forget that the warmth underneath the con artistry is the whole point. Lynch builds the found family through childhood flashbacks interleaved with the present heist, so you understand what each person is to the others before you see what they would sacrifice to keep them. The reversals hurt because you've been made to care. This is the standard for found-family grief in heist fantasy, and almost nothing written since has matched it." },
      { type: 'paragraph', text: "The dark humour lands because Lynch trusts you to hold both the comedy and the grief at the same time. The heist structure is genuinely clever — the reader gets enough of the plan to feel smart, but Lynch has always planned at least one layer deeper. The series runs to three books with a fourth in progress; the second book is more divisive but the third is where readers who loved the first feel they've been paid back." },
      { type: 'warning', text: "The Lies of Locke Lamora is a dark book — Lynch does not protect his characters, and the cost of the reversals is real and permanent. The novel interleaves the heist with childhood flashbacks, and some readers find the pacing of the first act slow as a result; the second act rewards the patience. The series is currently three books with a fourth long-delayed; readers should be aware they are entering an unfinished series." },
    ],
  },
  aspects: [
    {

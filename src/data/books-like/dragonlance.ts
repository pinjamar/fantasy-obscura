...
export const dragonlance: BooksLikeEntry = {
  ...
  source: {
    ...
    angle: 'Classic High Fantasy with the Most Compelling Mage in the Genre',
    answer_line:
  ...
  aspects: [
    ...
    {
      heading:
        'If you loved Raistlin — the brilliant, physically frail, morally ambiguous mage who is the most interesting person in any room and knows it...',
      recs: [
        {
  ...
  recommendations: [
    ...
    },
    {
      ...
      darkness_level: 3,
      heat_level: null,
      tags: ['Genius Mage', 'Tragedy', 'Magic Academy', 'Literary Fantasy'],
      why: "For readers who loved Raistlin specifically: Kvothe is the character built to the same specification — brilliant, self-destructive, convinced of his own exceptionalism in ways that are simultaneously irritating and completely justified, and in possession of a gift so large it functions as a curse. Rothfuss writes the prodigy's psychology better than almost anyone in the genre.",
      standalone: false,
      audiobook: true,
      amazon_url:
        'https://www.amazon.com/s?k=The+Name+of+the+Wind+Rothfuss&tag=librariancura-20',
    ...
    },
    {
      ...
      darkness_level: 4,
      heat_level: null,
      tags: ['Ensemble Cast', 'Brotherhood', 'Heist', 'Dark Fantasy'],
      why: "For readers who loved the party dynamic and the Caramon-Raistlin brother bond specifically: the Gentleman Bastards are a found family with the same structure — a group held together by loyalty that predates the current crisis, whose relationships with each other are more interesting than the external plot. Lynch writes male friendship with the same unironic emotional investment Weis and Hickman bring to Caramon and Raistlin, and the crew's interpersonal dynamics carry the book even when the heist mechanics slow down.",
      standalone: false,
      audiobook: true,
      amazon_url:

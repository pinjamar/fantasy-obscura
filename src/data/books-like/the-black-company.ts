...
export const theBlackCompany: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      { type: 'paragraph', text: "The Black Company earns its reputation by refusing nearly every convention fantasy had established by 1984. The Company works for the Lady — who is unambiguously a dark lord — and Cook never lets you forget that or softens it. The worldbuilding is dense and delivered sparingly; you piece together how dark the world actually is over time, and what you eventually understand is worse than what you initially suspected." },
      { type: 'labeled', label: 'Croaker:', text: "The annalist records events and doesn't interpret them — the prose has the efficiency of a military dispatch rather than an adventure story. This is not a limitation; it is a method. Croaker's refusal to moralize is what gives the book its moral weight: atrocities pass through the narration with the same tone as supply requisitions, and the reader has to do the work of registering what that means. The brotherhood of the Company is built from pragmatism rather than sentiment, and the loyalty is real precisely because it was never sentimental." },
      { type: 'paragraph', text: "No chosen ones. The villains are on the payroll. This is the template for most of what came after it in the grimdark tradition — Abercrombie cites it directly, Erikson built from it, and the distance between Cook's terse 1984 prose and everything that followed it shows how foundational the book was. Reading The Black Company is reading the genre's point of origin." },
      { type: 'warning', text: "The Black Company's prose is rougher than what the grimdark tradition it spawned eventually produced — this is not Abercrombie's polish or Erikson's scope, and the early chapters throw you in cold. Readers coming from more recent grimdark may find the construction sparse. The series is long (ten books across several publication periods) and uneven; the original trilogy (The Black Company, Shadows Linger, The White Rose) is the essential reading." },
    ],
  },
  aspects: [
    {
      ...
      recs: [
        {
          ...
          caveat: "Erikson throws you in with no orientation — the first 200 pages are deliberately disorienting and require patience. If you bounced off it, try Deadhouse Gates (book two) as an alternative entry point.",
          tags: [
            'Military Fantasy',
            'Massive Scope',
            'Ground-Level POV',
        ...
        },
        {
          ...
          caveat: "magic system is more prominent than in The Black Company — if you loved Cook's restrained, ominous approach to magic, McClellan's is more explicit and systematised.",
          tags: [
            'Military Fantasy',
            'Flintlock',
            'Grimdark',

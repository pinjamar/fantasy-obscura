...
export const theAwakeningZodiacAcademy: BooksLikeEntry = {
  ...
  source: {
    ...
    why_people_love_rich: [
      ...
      { type: 'labeled', label: 'The Heirs:', text: "The bullying isn't random cruelty but structured power protection: the Heirs have real reasons to prevent the Vega twins from claiming the Solarian throne, and the zodiac magic system gives those reasons institutional weight. Peckham and Valenti build the lore (the Fae hierarchy, the political stakes of two lost royal heirs, the zodiac powers) so that the antagonism has consequences beyond the personal — which is what elevates it from bully romance into something with genuine plot momentum." },
      ...
      recs: [
        {
          ...
          caveat: "book one is the weakest in the series by wide agreement — commit through book three before deciding.",
          tags: [
            'Hidden Identity',
            'Power Reveal',
            'Multiple LIs',

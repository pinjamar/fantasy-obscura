...
export const chroniclesOfAmber: ReadingOrderEntry = {
  ...
  cards: [
    ...
    },
    {
      ...
      body: "The ten books divide into two five-book cycles. The Corwin Cycle (1970-1978) is a complete, self-contained story with a proper ending — stopping at book 5 is a legitimate choice many readers make. The Merlin Cycle (1985–1991) follows Corwin's son Merlin, half Amber and half Courts of Chaos, working as a computer programmer in San Francisco while surviving assassination attempts. It requires the Corwin Cycle first and is more science-fiction in feel, structurally stranger, and more divisive.",
      color: 'green',
    },
    {

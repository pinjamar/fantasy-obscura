  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'The pacing is atmospheric rather than kinetic. The tension is in what cannot be trusted rather than in action sequences.',
        'Right for: readers who want fairy-tale gothic atmosphere and slow-burn dark romance. Not right for: readers who need kinetic plot-driven pacing or consistent world-building logic.',
      ],
    },
  ],
  darkness: [

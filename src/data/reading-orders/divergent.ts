...
export const divergent: ReadingOrderEntry = {
  ...
  description:
    "A YA dystopian trilogy set in a future Chicago divided into five factions (Dauntless, Erudite, Abnegation, Candor, Amity), each built around a single virtue taken to its extreme. At sixteen, you choose your faction. You leave your family. You become someone new. Sixteen-year-old Tris Prior chooses Dauntless and discovers she is Divergent. That's someone who doesn't fit the system, and a threat to everyone who controls it. Fast-paced and immediately addictive, read in order: Divergent → Insurgent → Allegiant. No required side reads.",
  ...
  orderNote:
    'Read the main trilogy first. The Four novellas cover the same timeline from his POV. Best read after Allegiant so you already know the full story. We Can Be Mended is the emotional coda if you need it.',
  cardsPosition: 'above',
  cards: [
    {
  ...
  sections: [
    ...
    },
    {
      ...
      type: 'warning',
      prose:
        "Allegiant's ending is one of the most controversial in YA fiction. It is permanent, intentional, and has never been changed despite significant fan pressure. Go in prepared.",
    },
  ],
  darkness: [
    {

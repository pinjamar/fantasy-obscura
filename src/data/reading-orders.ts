...
export const READING_ORDERS: ReadingOrderEntry[] = [
  ...
  // ─── Malazan Book of the Fallen ────────────────────────────────────────────
  {
    ...
    books: [
      ...
      { title: 'Night of Knives',              slug: 'night-of-knives',              status: 'optional',  note: '[Esslemont] Short and accessible — covers the night of the Emperor\'s death, a key event referenced throughout the main series.',                                               page_count: 256,  publication_year: 2004 },
      ...
      { title: 'Return of the Crimson Guard',  slug: 'return-of-the-crimson-guard',  status: 'optional',  note: '[Esslemont] The Crimson Guard — a mercenary company sworn to oppose the Empire — finally returns. Large cast, epic scope.',                                                     page_count: 768,  publication_year: 2008 },
      ...
      { title: 'Stonewielder',                 slug: 'stonewielder',                 status: 'optional',  note: '[Esslemont] The Malazan invasion of Korel, a land under the grip of a fanatical religion. Greymane\'s story.',                                                                  page_count: 720,  publication_year: 2010 },
      ...
      { title: 'Orb Sceptre Throne',           slug: 'orb-sceptre-throne',           status: 'optional',  note: '[Esslemont] Returns to Darujhistan — familiar characters, a new threat, and the aftermath of events from the main series.',                                                     page_count: 704,  publication_year: 2012 },
      ...
      { title: 'Blood and Bone',               slug: 'icse-blood-and-bone',          status: 'optional',  note: '[Esslemont] The continent of Jacuruku — one of the last unexplored corners of the world.',                                                                                      page_count: 608,  publication_year: 2012 },
      { title: 'Assail',                       slug: 'assail',                       status: 'optional',  note: '[Esslemont] The mystery of Assail — a land so deadly no army has ever conquered it — finally answered. Concludes the companion series.',                                        page_count: 640,  publication_year: 2015 },
    ],
    ...
    cards: [
      { title: '📚 The Scale',              body: '10 books. ~11,000 pages. The highest page count of any fantasy series. This is a months-long commitment — plan accordingly. The payoff is unlike anything else in the genre.',                                                                  color: 'blue'   },
      { title: '📖 The Companion Novels',   body: "Ian C. Esslemont's Novels of the Malazan Empire (6 books) cover events happening off-page in the main series. Not required — Erikson's 10 books are self-contained — but slot in naturally after specific main series entries. See the companion group below.", color: 'purple' },
    ],
  ...
  // ─── The Kingkiller Chronicle ──────────────────────────────────────────────
  {
    ...
    books: [
      ...
      { title: 'The Doors of Stone',                slug: null,                                status: 'incomplete',    note: 'Book 3 and the trilogy finale. No release date announced as of 2026 — in development since 2011.',                                               page_count: null, publication_year: null },
    ],
    warning: "The Doors of Stone (book 3) has been in development since 2011 with no release date as of 2026. Many readers prefer to wait before starting. The two published books end on open threads.",
    orderNote: 'Start with The Name of the Wind. No other order is possible.',
    cards: [
      { title: '✍️ The Prose',     body: 'Rothfuss writes with more precision and beauty than almost anyone in the genre. The Name of the Wind is the most technically accomplished debut in modern fantasy — the prose alone is reason enough to read it.',           color: 'blue'   },
      { title: '⏳ The Wait',      body: 'Book 3 has had no release date since 2011. Go in with eyes open — the series ends mid-story and may wait years more. Many readers choose to wait until The Doors of Stone is announced before starting.',                  color: 'amber'  },
      { title: '📖 The Novella',   body: 'The Slow Regard of Silent Things is optional — Rothfuss himself says it is not for everyone. It follows Auri with no plot. Skip it unless you found her fascinating. You will miss nothing essential.',                   color: 'purple' },
    ],
    sections: [
      {
  ...
  // ─── The Dresden Files ─────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      },
      {
        ...
        books: [
          ...
          { title: 'Side Jobs',     slug: 'side-jobs',     status: 'optional',  note: 'Anthology of 11 short stories and novellas set during books 1–11 — including "Restoration of Faith", "Backup" (Thomas POV), "The Warrior", and "Last Call". The final story "Aftermath" bridges directly into Ghost Story — save it for right after Changes.',  page_count: 416, publication_year: 2011 },
        ],
      },
      {
        ...
        books: [
          ...
          { title: 'Brief Cases',  slug: 'brief-cases',  status: 'optional',  note: 'Anthology of 12 stories set around books 10–17 — including the novella "Ghoul Goblin", "Even Hand" (Marcone POV), "Bombshells" (Andi POV), "Cold Case" (Molly POV), and "Jury Duty" (post-Skin Game). Read before Peace Talks.',  page_count: 512, publication_year: 2018 },
        ],
      },
      {
        label: 'The Aftermath',
        ...
        books: [
          ...
          { title: 'Twelve Months',  slug: 'twelve-months',  status: 'upcoming',  note: 'Book 18. Expected 2026. Butcher has confirmed it picks up in the aftermath of Battle Ground.',                       page_count: null, publication_year: 2026 },
        ],
      },
    ],
    ...
    darkness: [
      { label: 'Books 1–11',  level: 3, desc: 'Serious — noir tone, violence, war and loss, but always a thread of hope' },
      { label: 'Books 12–17', level: 5, desc: 'Brutal — major deaths, catastrophic stakes, no safety net' },
    ],
  ...
  // ─── Blood and Ash ─────────────────────────────────────────────────────────
  {
    ...
    groups: [
      {
        ...
        books: [
          ...
          { title: 'The Primal of Blood and Bone', slug: 'the-primal-of-blood-and-bone', status: 'mandatory', note: 'Book 6. Old enemies rise and ancient powers stir. Poppy and Casteel face their most perilous challenges yet.',                                        page_count: 608, publication_year: 2025 },
          { title: 'A Crown of Ruin',              slug: 'a-crown-of-ruin',              status: 'optional',  note: 'Free novella bridging The Primal of Blood and Bone and The Throne of Bone and Ash. Fills in emotional gaps and aftermath not seen on the page.',       page_count: null, publication_year: 2025 },
          { title: 'The Throne of Bone and Ash',  slug: 'the-throne-of-bone-and-ash',  status: 'upcoming',  note: 'The final book in the main series. Expected Spring 2026.',                                                                                              page_count: null, publication_year: 2026 },
        ],
      },
      {
        ...
        books: [
          { title: 'A Shadow in the Ember', slug: 'a-shadow-in-the-ember', status: 'mandatory', note: 'Start of the companion series. Follows Sera, a mortal woman fated to the God of Death, Nyktos. Dark and romantic — a different tone to book 1 of Blood and Ash.', page_count: 622, publication_year: 2021 },
          { title: 'A Light in the Flame',  slug: 'a-light-in-the-flame',  status: 'mandatory', note: 'The bond between Sera and Nyktos deepens as the stakes rise. The world and mythology of Blood and Ash begins to connect.',                                         page_count: 638, publication_year: 2022 },
          { title: 'A Fire in the Flesh',   slug: 'a-fire-in-the-flesh',   status: 'mandatory', note: 'The two storylines begin to converge. Answers to questions seeded in the main series start to emerge.',                                                            page_count: 569, publication_year: 2023 },
          { title: 'Born of Blood and Ash', slug: 'born-of-blood-and-ash', status: 'mandatory', note: 'The Flesh and Fire series concludes. Connects directly to the main Blood and Ash storyline.',                                                                      page_count: 560, publication_year: 2024 },
        ],
      },
    ],
    orderNote: 'The main series (books 1–6+) comes first. The Flesh and Fire companion series slots in after book 4 — the two storylines converge by the end of Born of Blood and Ash.',
    cardsPosition: 'above',
    cards: [
      ...
      { title: '⚔️ The Shift',    body: 'By The Crown of Gilded Bones the romance takes a back seat to world-building and war. Books 3 onward are significantly more plot-heavy and darker than the first two.',                            color: 'amber'  },
    ...
    darkness: [
      { label: 'Books 1–2',          level: 3, desc: 'Serious — romance-forward, danger present but filtered' },
      { label: 'Books 3–6',          level: 4, desc: 'Dark — war, torture, heavy losses, escalating stakes' },
      { label: 'Flesh and Fire 1–4', level: 4, desc: 'Dark — gods, fate, and sacrifice; comparable tone to books 3–4' },
    ],
    finishedLabel: "Finished what's published?",
    categoryHref: '/fantasy/romantasy',
    categoryLabel: 'Browse Romantasy',
    ...
    groups: [
      ...
      },
      {
        ...
        books: [
          ...
          { title: 'The Adversary',   slug: 'the-adversary', status: 'optional',      seriesLabel: 'The Sundering #3', note: "By Erin M. Evans. Follows Farideh from the Brimstone Angels series. Unrelated to Drizzt's storyline.", page_count: 352, publication_year: 2013 },
          { title: 'The Reaver',      slug: 'the-reaver',    status: 'optional',      seriesLabel: 'The Sundering #4', note: 'By Richard Lee Byers. Pirate adventure during the Sundering chaos. Standalone among the six.', page_count: 320, publication_year: 2014 },
          { title: 'The Sentinel',    slug: 'the-sentinel',  status: 'optional',      seriesLabel: 'The Sundering #5', note: 'By Troy Denning. Follows Kleef Kenric, a paladin of Helm. Minimal connection to Drizzt.', page_count: 352, publication_year: 2014 },
    ...
    groups: [
      ...
      },
      {
        ...
        books: [
          ...
          { title: 'The World of Divergent',        slug: 'the-world-of-divergent-the-path-to-allegiant', status: 'supplementary', note: 'Behind-the-scenes companion — Roth\'s path to Allegiant, faction manifestos, quiz. Non-fiction. For fans only.',                                  page_count: 100, publication_year: 2013 },
        ],
      },
    ],
  ...
  // ─── Dragonriders of Pern ──────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      },
      {
        ...
        books: [
          ...
          { title: 'Dragondrums',  slug: 'dragon-drums',  status: 'optional',  seriesLabel: 'Harper Hall #3', note: 'Switches protagonist to Piemur. Less essential than the first two but rounds out the Harper Hall world nicely. Read before The White Dragon.',                                                              page_count: 243, publication_year: 1979 },
        ],
      },
      {
        ...
        books: [
          ...
          { title: 'Dragonseye',                 slug: 'dragonseye',                status: 'optional',      seriesLabel: 'Pern #13', note: 'Set 500 years after the colonists arrived, depicting the second Pass of Thread. Bridges the early colony era and the main series. For fans who want more Anne McCaffrey Pern after the core books.',                   page_count: 378, publication_year: 1996 },
          { title: 'The Masterharper of Pern',   slug: 'the-masterharper-of-pern',  status: 'optional',      seriesLabel: 'Pern #14', note: 'Robinton\'s life from childhood to his role in the main trilogy. A love letter to the Harper Hall. Essential for anyone who fell for Robinton in the earlier books.',                                                  page_count: 432, publication_year: 1998 },
          { title: 'The Skies of Pern',          slug: 'the-skies-of-pern',         status: 'optional',      seriesLabel: 'Pern #15', note: 'Final Anne McCaffrey solo Pern novel. Deals with the aftermath of Thread\'s end and a new source of conflict. A gentle farewell from McCaffrey to the world she built.',                                              page_count: 368, publication_year: 2001 },
        ],
      },
      {
      ...
      },
      {
        ...
        noteType: 'optional',
        books: [
          { title: 'Dragon\'s Kin',    slug: 'dragons-kin',    status: 'supplementary', seriesLabel: 'Pern #16', note: 'Anne & Todd McCaffrey. A young boy and his watch-wher during a mining crisis. Introduces watch-whers as central characters. Gentler and more YA in tone.',           page_count: 317, publication_year: 2003 },
          { title: 'Dragon\'s Fire',   slug: 'dragons-fire',   status: 'supplementary', seriesLabel: 'Pern #18', note: 'Anne & Todd McCaffrey. Watch-whers again, plus the origin of firestone. Connects the watch-wher thread to the larger Pern history.',                                page_count: 276, publication_year: 2006 },
          { title: 'Dragon Harper',    slug: 'dragon-harper',  status: 'supplementary', seriesLabel: 'Pern #19', note: 'Anne & Todd McCaffrey. A harper apprentice during a plague — echoes of Moreta. The last Anne/Todd collaboration before Todd continued solo.',                        page_count: 306, publication_year: 2007 },
          { title: 'Dragonsblood',     slug: 'dragonsblood',   status: 'supplementary', seriesLabel: 'Pern #17', note: 'Todd McCaffrey solo. Two timelines — present-day Pern facing a dragon plague, and the distant past. His debut solo novel and the strongest of his Pern books.',      page_count: 441, publication_year: 2005 },
          { title: 'Dragonheart',      slug: 'dragonheart',    status: 'supplementary', seriesLabel: 'Pern #20', note: 'Todd McCaffrey solo. Follows the plague storyline from Dragonsblood. More dragon-focused, slower-paced. For completionists.',                                         page_count: 432, publication_year: 2008 },
          { title: 'Dragongirl',       slug: 'dragongirl',     status: 'supplementary', seriesLabel: 'Pern #21', note: 'Todd McCaffrey solo. Conclusion to the plague arc. Wraps up the threads started in Dragonsblood. Best read in sequence.',                                             page_count: 416, publication_year: 2010 },
          { title: 'Dragon\'s Time',   slug: 'dragons-time',   status: 'supplementary', seriesLabel: 'Pern #22', note: 'Anne & Todd McCaffrey. Time travel to save Pern from the plague. Ambitious but the continuity gets complex — best read after the other Todd books.',                page_count: 304, publication_year: 2011 },
          { title: 'Sky Dragons',      slug: 'sky-dragons',    status: 'supplementary', seriesLabel: 'Pern #23', note: 'Anne & Todd McCaffrey. The final collaboration. Young riders in the distant past. A fitting close to the Anne/Todd era.',                                             page_count: 302, publication_year: 2012 },
        ],
      },
    ],
    cardsPosition: 'above',
    cards: [
      ...
      { title: '📖 How Far to Read',         body: 'The first six books (Dragonriders trilogy + Harper Hall) are Pern at its best. The expansion novels — Dragonsdawn, Moreta, Masterharper — reward readers who love the world. The Todd McCaffrey continuations exist if you want even more Pern after Anne\'s death in 2011, but they are a different, lighter experience.', color: 'green' },
      { title: '💀 The Dragon Bond',         body: 'The bond between rider and dragon is telepathic, lifelong, and ends only in death. When a dragon dies, the rider almost never survives the grief — they go between and don\'t come back. It\'s one of the most emotionally devastating devices in all of fantasy and McCaffrey uses it without mercy.', color: 'purple' },
    ],
    sections: [
      {
    ...
    darkness: [
      { label: 'Main trilogy',             level: 2, desc: 'Some violence and genuine threat — Thread is dangerous and dragon death is devastating — but overall light' },
      { label: 'Harper Hall',              level: 1, desc: 'YA — the darkest element is social cruelty, parental neglect and the cost of talent in a rigid society' },
      { label: 'Expansion novels',         level: 3, desc: 'Moreta is the darkest Anne McCaffrey book — plague, sacrifice, and a genuinely tragic ending' },
      { label: 'Todd McCaffrey books',     level: 2, desc: 'Lighter tone overall — dragon plague storylines but less emotional weight than Anne\'s best work' },
    ],
  ...
  // ─── Grishaverse ──────────────────────────────────────────────────────────
  {
    ...
    cardsPosition: 'above',
    cards: [
      { title: '🌑 Shadow and Bone (3 books)', body: 'The foundation trilogy. Introduces Ravka, Grisha magic, and the Fold. Required reading before anything else — establishes the world every other series depends on.',  color: 'blue'   },
      { title: '🃏 Six of Crows (2 books)',    body: 'The best of the Grishaverse — a heist duology with one of the finest ensemble casts in modern fantasy. The reason most people stay.',                                color: 'purple' },
      { title: '👑 King of Scars (2 books)',   body: 'Nikolai\'s duology. Optional but rewarding — draws characters from both previous series and gives the world a proper conclusion.',                                    color: 'green'  },
      { title: '📖 Companion works (2 books)', body: 'The Language of Thorns and The Lives of Saints. World-building extras — beautiful but not essential to the main story.',                                              color: 'amber'  },
    ],
    sections: [
      {
    ...
    groups: [
      ...
      },
      {
        ...
        books: [
          ...
          { title: 'Foundation',            slug: 'foundation-valdemar',   status: 'optional',      seriesLabel: 'Collegium Chronicles #1', note: 'Mags — a mine slave discovered to be a Herald-trainee. Written as a new entry point to Valdemar. More deliberate pacing than the original trilogy. Good for younger readers.',                               page_count: 337, publication_year: 2008 },
